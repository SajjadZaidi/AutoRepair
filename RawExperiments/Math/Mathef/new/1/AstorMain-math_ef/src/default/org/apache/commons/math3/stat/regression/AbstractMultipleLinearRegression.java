...
public abstract class AbstractMultipleLinearRegression implements org.apache.commons.math3.stat.regression.MultipleLinearRegression {
	...
	public void newSampleData(double[] data, int nobs, int nvars) {
		...
		if (nobs <= nvars) {
			throw new org.apache.commons.math3.exception.InsufficientDataException(org.apache.commons.math3.exception.util.LocalizedFormats.INSUFFICIENT_OBSERVED_POINTS_IN_SAMPLE , nobs , (nvars + 1));
		} 
	...
	public double estimateRegressionStandardError() {
		return org.apache.commons.math3.util.FastMath.sqrt(estimateErrorVariance());
	}
