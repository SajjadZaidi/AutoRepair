...
public class FastMath {
	...
	private static double doubleHighPart(double d) {
		...
		xl &= org.apache.commons.math3.util.FastMath.MASK_30BITS;
	...
	public static double nextDown(final double a) {
		return org.apache.commons.math3.util.FastMath.nextAfter(a, java.lang.Double.NEGATIVE_INFINITY);
	}

	public static float nextDown(final float a) {
		return org.apache.commons.math3.util.FastMath.nextAfter(a, java.lang.Float.NEGATIVE_INFINITY);
	}
	...
	private static double atan(double xa, double xb, boolean leftPlane) {
		...
		final double ttA = org.apache.commons.math3.util.FastMath.TANGENT_TABLE_A[idx];
		final double ttB = org.apache.commons.math3.util.FastMath.TANGENT_TABLE_B[idx];
		double epsA = xa - ttA;
		...
		final double eighths = org.apache.commons.math3.util.FastMath.EIGHTHS[idx];
	...
	public static int toIntExact(final long n) throws org.apache.commons.math3.exception.MathArithmeticException {
	...
	public static int incrementExact(final int n) throws org.apache.commons.math3.exception.MathArithmeticException {
		if (n == (java.lang.Integer.MAX_VALUE)) {
			throw new org.apache.commons.math3.exception.MathArithmeticException(org.apache.commons.math3.exception.util.LocalizedFormats.OVERFLOW_IN_ADDITION , n , 1);
		} 
		return n + 1;
	}

	public static long incrementExact(final long n) throws org.apache.commons.math3.exception.MathArithmeticException {
	...
	public static int decrementExact(final int n) throws org.apache.commons.math3.exception.MathArithmeticException {
		if (n == (java.lang.Integer.MIN_VALUE)) {
			throw new org.apache.commons.math3.exception.MathArithmeticException(org.apache.commons.math3.exception.util.LocalizedFormats.OVERFLOW_IN_SUBTRACTION , n , 1);
		} 
		return n - 1;
	}

	public static long decrementExact(final long n) throws org.apache.commons.math3.exception.MathArithmeticException {
	...
	public static int addExact(final int a, final int b) throws org.apache.commons.math3.exception.MathArithmeticException {
		final int sum = a + b;
		if (((a ^ b) >= 0) && ((sum ^ b) < 0)) {
	...
	public static long addExact(final long a, final long b) throws org.apache.commons.math3.exception.MathArithmeticException {
		final long sum = a + b;
		if (((a ^ b) >= 0) && ((sum ^ b) < 0)) {
			throw new org.apache.commons.math3.exception.MathArithmeticException(org.apache.commons.math3.exception.util.LocalizedFormats.OVERFLOW_IN_ADDITION , a , b);
		} 
	...
	public static int subtractExact(final int a, final int b) {
		final int sub = a - b;
		if (((a ^ b) < 0) && ((sub ^ b) >= 0)) {
			throw new org.apache.commons.math3.exception.MathArithmeticException(org.apache.commons.math3.exception.util.LocalizedFormats.OVERFLOW_IN_SUBTRACTION , a , b);
		} 
		return sub;
	}
	...
	public static int multiplyExact(final int a, final int b) {
		if ((((b > 0) && ((a > ((java.lang.Integer.MAX_VALUE) / b)) || (a < ((java.lang.Integer.MIN_VALUE) / b)))) || ((b < (-1)) && ((a > ((java.lang.Integer.MIN_VALUE) / b)) || (a < ((java.lang.Integer.MAX_VALUE) / b))))) || ((b == (-1)) && (a == (java.lang.Integer.MIN_VALUE)))) {
			throw new org.apache.commons.math3.exception.MathArithmeticException(org.apache.commons.math3.exception.util.LocalizedFormats.OVERFLOW_IN_MULTIPLICATION , a , b);
		} 
		return a * b;
	}
	...
	public static int floorDiv(final int a, final int b) throws org.apache.commons.math3.exception.MathArithmeticException {
		if (b == 0) {
	...
	public static long floorDiv(final long a, final long b) throws org.apache.commons.math3.exception.MathArithmeticException {
		if (b == 0L) {
			throw new org.apache.commons.math3.exception.MathArithmeticException(org.apache.commons.math3.exception.util.LocalizedFormats.ZERO_DENOMINATOR);
		} 
		final long m = a % b;
	...
	public static int floorMod(final int a, final int b) throws org.apache.commons.math3.exception.MathArithmeticException {
		if (b == 0) {
			throw new org.apache.commons.math3.exception.MathArithmeticException(org.apache.commons.math3.exception.util.LocalizedFormats.ZERO_DENOMINATOR);
		} 
		final int m = a % b;
