...
public class WeibullDistribution extends org.apache.commons.math3.distribution.AbstractRealDistribution {
	...
	public WeibullDistribution(org.apache.commons.math3.random.RandomGenerator rng ,double alpha ,double beta) throws org.apache.commons.math3.exception.NotStrictlyPositiveException {
		this(rng, alpha, beta, org.apache.commons.math3.distribution.WeibullDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
	}
	...
	public double logDensity(double x) {
		...
		final double xscale = x / (scale);
		final double logxscalepow = (org.apache.commons.math3.util.FastMath.log(xscale)) * ((shape) - 1);
		final double xscalepowshape = (org.apache.commons.math3.util.FastMath.exp(logxscalepow)) * xscale;
		return ((org.apache.commons.math3.util.FastMath.log(((shape) / (scale)))) + logxscalepow) - xscalepowshape;
	}
	...
	public double inverseCumulativeProbability(double p) {
		...
		if ((p < 0.0) || (p > 1.0)) {
			...
			ret = (scale) * (org.apache.commons.math3.util.FastMath.pow((-(org.apache.commons.math3.util.FastMath.log1p((-p)))), (1.0 / (shape))));
		}
		return ret;
	}
