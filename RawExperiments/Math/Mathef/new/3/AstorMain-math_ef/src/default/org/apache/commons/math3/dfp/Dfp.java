...
public class Dfp implements org.apache.commons.math3.RealFieldElement<org.apache.commons.math3.dfp.Dfp> {
	...
	protected int complement(int extra) {
		...
		extra -= rh * (org.apache.commons.math3.dfp.Dfp.RADIX);
		for (int i = 0 ; i < (mant.length) ; i++) {
	...
	public org.apache.commons.math3.dfp.Dfp dotrap(int type, java.lang.String what, org.apache.commons.math3.dfp.Dfp oper, org.apache.commons.math3.dfp.Dfp result) {
		...
		switch (type) {
			...
			case org.apache.commons.math3.dfp.DfpField.FLAG_UNDERFLOW :
				...
				result.exp += org.apache.commons.math3.dfp.Dfp.ERR_SCALE;
				break;
	...
	public org.apache.commons.math3.dfp.Dfp add(final double a) {
		return add(newInstance(a));
	}

	public org.apache.commons.math3.dfp.Dfp subtract(final double a) {
		return subtract(newInstance(a));
	}

	public org.apache.commons.math3.dfp.Dfp multiply(final double a) {
		return multiply(newInstance(a));
	}

	public org.apache.commons.math3.dfp.Dfp divide(final double a) {
		return divide(newInstance(a));
	}

	public org.apache.commons.math3.dfp.Dfp remainder(final double a) {
		return remainder(newInstance(a));
	}

	public long round() {
		return org.apache.commons.math3.util.FastMath.round(toDouble());
	}
	...
	public org.apache.commons.math3.dfp.Dfp copySign(final org.apache.commons.math3.dfp.Dfp s) {
	...
	public org.apache.commons.math3.dfp.Dfp copySign(final double s) {
		long sb = java.lang.Double.doubleToLongBits(s);
	...
	public org.apache.commons.math3.dfp.Dfp scalb(final int n) {
		return multiply(org.apache.commons.math3.dfp.DfpMath.pow(getTwo(), n));
	}

	public org.apache.commons.math3.dfp.Dfp hypot(final org.apache.commons.math3.dfp.Dfp y) {
		return multiply(org.apache.commons.math3.dfp.Dfp.this).add(y.multiply(y)).sqrt();
	}
	...
	public org.apache.commons.math3.dfp.Dfp rootN(final int n) {
		return (sign) >= 0 ? org.apache.commons.math3.dfp.DfpMath.pow(org.apache.commons.math3.dfp.Dfp.this, getOne().divide(n)) : org.apache.commons.math3.dfp.DfpMath.pow(negate(), getOne().divide(n)).negate();
	}

	public org.apache.commons.math3.dfp.Dfp pow(final double p) {
		return org.apache.commons.math3.dfp.DfpMath.pow(org.apache.commons.math3.dfp.Dfp.this, newInstance(p));
	}

	public org.apache.commons.math3.dfp.Dfp pow(final int n) {
		return org.apache.commons.math3.dfp.DfpMath.pow(org.apache.commons.math3.dfp.Dfp.this, n);
	}

	public org.apache.commons.math3.dfp.Dfp pow(final org.apache.commons.math3.dfp.Dfp e) {
		return org.apache.commons.math3.dfp.DfpMath.pow(org.apache.commons.math3.dfp.Dfp.this, e);
	}

	public org.apache.commons.math3.dfp.Dfp exp() {
		return org.apache.commons.math3.dfp.DfpMath.exp(org.apache.commons.math3.dfp.Dfp.this);
	}

	public org.apache.commons.math3.dfp.Dfp expm1() {
		return org.apache.commons.math3.dfp.DfpMath.exp(org.apache.commons.math3.dfp.Dfp.this).subtract(getOne());
	}

	public org.apache.commons.math3.dfp.Dfp log() {
		return org.apache.commons.math3.dfp.DfpMath.log(org.apache.commons.math3.dfp.Dfp.this);
	}

	public org.apache.commons.math3.dfp.Dfp log1p() {
		return org.apache.commons.math3.dfp.DfpMath.log(org.apache.commons.math3.dfp.Dfp.this.add(getOne()));
	}
	...
	public org.apache.commons.math3.dfp.Dfp cos() {
		return org.apache.commons.math3.dfp.DfpMath.cos(org.apache.commons.math3.dfp.Dfp.this);
	}

	public org.apache.commons.math3.dfp.Dfp sin() {
		return org.apache.commons.math3.dfp.DfpMath.sin(org.apache.commons.math3.dfp.Dfp.this);
	}

	public org.apache.commons.math3.dfp.Dfp tan() {
		return org.apache.commons.math3.dfp.DfpMath.tan(org.apache.commons.math3.dfp.Dfp.this);
	}

	public org.apache.commons.math3.dfp.Dfp acos() {
		return org.apache.commons.math3.dfp.DfpMath.acos(org.apache.commons.math3.dfp.Dfp.this);
	}

	public org.apache.commons.math3.dfp.Dfp asin() {
		return org.apache.commons.math3.dfp.DfpMath.asin(org.apache.commons.math3.dfp.Dfp.this);
	}

	public org.apache.commons.math3.dfp.Dfp atan() {
		return org.apache.commons.math3.dfp.DfpMath.atan(org.apache.commons.math3.dfp.Dfp.this);
	}

	public org.apache.commons.math3.dfp.Dfp atan2(final org.apache.commons.math3.dfp.Dfp x) throws org.apache.commons.math3.exception.DimensionMismatchException {
		final org.apache.commons.math3.dfp.Dfp r = x.multiply(x).add(multiply(org.apache.commons.math3.dfp.Dfp.this)).sqrt();
		if ((x.sign) >= 0) {
	...
	public org.apache.commons.math3.dfp.Dfp cosh() {
		return org.apache.commons.math3.dfp.DfpMath.exp(org.apache.commons.math3.dfp.Dfp.this).add(org.apache.commons.math3.dfp.DfpMath.exp(negate())).divide(2);
	}

	public org.apache.commons.math3.dfp.Dfp sinh() {
		return org.apache.commons.math3.dfp.DfpMath.exp(org.apache.commons.math3.dfp.Dfp.this).subtract(org.apache.commons.math3.dfp.DfpMath.exp(negate())).divide(2);
	}

	public org.apache.commons.math3.dfp.Dfp tanh() {
		final org.apache.commons.math3.dfp.Dfp ePlus = org.apache.commons.math3.dfp.DfpMath.exp(org.apache.commons.math3.dfp.Dfp.this);
		final org.apache.commons.math3.dfp.Dfp eMinus = org.apache.commons.math3.dfp.DfpMath.exp(negate());
		return ePlus.subtract(eMinus).divide(ePlus.add(eMinus));
	}

	public org.apache.commons.math3.dfp.Dfp acosh() {
		return multiply(org.apache.commons.math3.dfp.Dfp.this).subtract(getOne()).sqrt().add(org.apache.commons.math3.dfp.Dfp.this).log();
	}

	public org.apache.commons.math3.dfp.Dfp asinh() {
		return multiply(org.apache.commons.math3.dfp.Dfp.this).add(getOne()).sqrt().add(org.apache.commons.math3.dfp.Dfp.this).log();
	}

	public org.apache.commons.math3.dfp.Dfp atanh() {
		return getOne().add(org.apache.commons.math3.dfp.Dfp.this).divide(getOne().subtract(org.apache.commons.math3.dfp.Dfp.this)).log().divide(2);
	}

	public org.apache.commons.math3.dfp.Dfp linearCombination(final org.apache.commons.math3.dfp.Dfp[] a, final org.apache.commons.math3.dfp.Dfp[] b) throws org.apache.commons.math3.exception.DimensionMismatchException {
		if ((a.length) != (b.length)) {
			throw new org.apache.commons.math3.exception.DimensionMismatchException(a.length , b.length);
		} 
		org.apache.commons.math3.dfp.Dfp r = getZero();
	...
	public org.apache.commons.math3.dfp.Dfp linearCombination(final double[] a, final org.apache.commons.math3.dfp.Dfp[] b) throws org.apache.commons.math3.exception.DimensionMismatchException {
		if ((a.length) != (b.length)) {
			throw new org.apache.commons.math3.exception.DimensionMismatchException(a.length , b.length);
		} 
		org.apache.commons.math3.dfp.Dfp r = getZero();
	...
	public org.apache.commons.math3.dfp.Dfp linearCombination(final org.apache.commons.math3.dfp.Dfp a1, final org.apache.commons.math3.dfp.Dfp b1, final org.apache.commons.math3.dfp.Dfp a2, final org.apache.commons.math3.dfp.Dfp b2) {
		return a1.multiply(b1).add(a2.multiply(b2));
	}

	public org.apache.commons.math3.dfp.Dfp linearCombination(final double a1, final org.apache.commons.math3.dfp.Dfp b1, final double a2, final org.apache.commons.math3.dfp.Dfp b2) {
		return b1.multiply(a1).add(b2.multiply(a2));
	}

	public org.apache.commons.math3.dfp.Dfp linearCombination(final org.apache.commons.math3.dfp.Dfp a1, final org.apache.commons.math3.dfp.Dfp b1, final org.apache.commons.math3.dfp.Dfp a2, final org.apache.commons.math3.dfp.Dfp b2, final org.apache.commons.math3.dfp.Dfp a3, final org.apache.commons.math3.dfp.Dfp b3) {
		return a1.multiply(b1).add(a2.multiply(b2)).add(a3.multiply(b3));
	}

	public org.apache.commons.math3.dfp.Dfp linearCombination(final double a1, final org.apache.commons.math3.dfp.Dfp b1, final double a2, final org.apache.commons.math3.dfp.Dfp b2, final double a3, final org.apache.commons.math3.dfp.Dfp b3) {
		return b1.multiply(a1).add(b2.multiply(a2)).add(b3.multiply(a3));
	}

	public org.apache.commons.math3.dfp.Dfp linearCombination(final org.apache.commons.math3.dfp.Dfp a1, final org.apache.commons.math3.dfp.Dfp b1, final org.apache.commons.math3.dfp.Dfp a2, final org.apache.commons.math3.dfp.Dfp b2, final org.apache.commons.math3.dfp.Dfp a3, final org.apache.commons.math3.dfp.Dfp b3, final org.apache.commons.math3.dfp.Dfp a4, final org.apache.commons.math3.dfp.Dfp b4) {
		return a1.multiply(b1).add(a2.multiply(b2)).add(a3.multiply(b3)).add(a4.multiply(b4));
	}

	public org.apache.commons.math3.dfp.Dfp linearCombination(final double a1, final org.apache.commons.math3.dfp.Dfp b1, final double a2, final org.apache.commons.math3.dfp.Dfp b2, final double a3, final org.apache.commons.math3.dfp.Dfp b3, final double a4, final org.apache.commons.math3.dfp.Dfp b4) {
