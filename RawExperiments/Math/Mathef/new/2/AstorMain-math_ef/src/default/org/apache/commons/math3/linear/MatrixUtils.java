...
public class MatrixUtils {
	...
	public static <T extends org.apache.commons.math3.FieldElement<T>>org.apache.commons.math3.linear.FieldMatrix<T> createFieldIdentityMatrix(final org.apache.commons.math3.Field<T> field, final int dimension) {
		...
		final T[][] d = org.apache.commons.math3.util.MathArrays.buildArray(field, dimension, dimension);
	...
	public static org.apache.commons.math3.linear.RealMatrix blockInverse(org.apache.commons.math3.linear.RealMatrix m, int splitIndex) {
		...
		final org.apache.commons.math3.linear.DecompositionSolver aSolver = aDec.getSolver();
		if (!(aSolver.isNonSingular())) {
			throw new org.apache.commons.math3.linear.SingularMatrixException();
		} 
		final org.apache.commons.math3.linear.RealMatrix aInv = aSolver.getInverse();
		...
		final org.apache.commons.math3.linear.DecompositionSolver dSolver = dDec.getSolver();
		if (!(dSolver.isNonSingular())) {
			throw new org.apache.commons.math3.linear.SingularMatrixException();
		} 
		final org.apache.commons.math3.linear.RealMatrix dInv = dSolver.getInverse();
		...
		final org.apache.commons.math3.linear.DecompositionSolver tmp1Solver = tmp1Dec.getSolver();
		if (!(tmp1Solver.isNonSingular())) {
			throw new org.apache.commons.math3.linear.SingularMatrixException();
		} 
		final org.apache.commons.math3.linear.RealMatrix result00 = tmp1Solver.getInverse();
		...
		final org.apache.commons.math3.linear.DecompositionSolver tmp2Solver = tmp2Dec.getSolver();
		if (!(tmp2Solver.isNonSingular())) {
			throw new org.apache.commons.math3.linear.SingularMatrixException();
		} 
		final org.apache.commons.math3.linear.RealMatrix result11 = tmp2Solver.getInverse();
	...
	public static org.apache.commons.math3.linear.RealMatrix inverse(org.apache.commons.math3.linear.RealMatrix matrix) throws org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.linear.NonSquareMatrixException, org.apache.commons.math3.linear.SingularMatrixException {
		return org.apache.commons.math3.linear.MatrixUtils.inverse(matrix, 0);
	}

	public static org.apache.commons.math3.linear.RealMatrix inverse(org.apache.commons.math3.linear.RealMatrix matrix, double threshold) throws org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.linear.NonSquareMatrixException, org.apache.commons.math3.linear.SingularMatrixException {
		org.apache.commons.math3.util.MathUtils.checkNotNull(matrix);
		if (!(matrix.isSquare())) {
			throw new org.apache.commons.math3.linear.NonSquareMatrixException(matrix.getRowDimension() , matrix.getColumnDimension());
		} 
		if (matrix instanceof org.apache.commons.math3.linear.DiagonalMatrix) {
			return ((org.apache.commons.math3.linear.DiagonalMatrix)(matrix)).inverse(threshold);
		} else {
			org.apache.commons.math3.linear.QRDecomposition decomposition = new org.apache.commons.math3.linear.QRDecomposition(matrix , threshold);
