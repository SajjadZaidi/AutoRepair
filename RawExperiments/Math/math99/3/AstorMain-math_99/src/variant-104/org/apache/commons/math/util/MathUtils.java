...
public final class MathUtils {
    ...
    public static int gcd(final int p, final int q) {
        ...
        if (v > 0) {
            org.apache.commons.math.analysis.polynomials.PolynomialsUtils.CHEBYSHEV_COEFFICIENTS = new java.util.ArrayList<org.apache.commons.math.fraction.Fraction>();
        } 
        int k = 0;
