...
public class GammaDistribution extends org.apache.commons.math3.distribution.AbstractRealDistribution {
	...
	public GammaDistribution(org.apache.commons.math3.random.RandomGenerator rng ,double shape ,double scale) throws org.apache.commons.math3.exception.NotStrictlyPositiveException {
		this(rng, shape, scale, org.apache.commons.math3.distribution.GammaDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
	}
	...
	public GammaDistribution(org.apache.commons.math3.random.RandomGenerator rng ,double shape ,double scale ,double inverseCumAccuracy) throws org.apache.commons.math3.exception.NotStrictlyPositiveException {
		...
		this.logDensityPrefactor2 = ((org.apache.commons.math3.util.FastMath.log(shape)) + (0.5 * (org.apache.commons.math3.util.FastMath.log(aux)))) - (org.apache.commons.math3.util.FastMath.log(org.apache.commons.math3.special.Gamma.lanczos(shape)));
		...
		this.logDensityPrefactor1 = ((((org.apache.commons.math3.distribution.GammaDistribution.this.logDensityPrefactor2) - (org.apache.commons.math3.util.FastMath.log(scale))) - ((org.apache.commons.math3.util.FastMath.log(shiftedShape)) * shape)) + shape) + (org.apache.commons.math3.special.Gamma.LANCZOS_G);
	...
	public double logDensity(double x) {
		...
		if ((y <= (minY)) || ((org.apache.commons.math3.util.FastMath.log(y)) >= (maxLogY))) {
			...
			final double aux2 = (shape) * ((org.apache.commons.math3.util.FastMath.log1p(aux1)) - aux1);
			final double aux3 = ((((-y) * ((org.apache.commons.math3.special.Gamma.LANCZOS_G) + 0.5)) / (shiftedShape)) + (org.apache.commons.math3.special.Gamma.LANCZOS_G)) + aux2;
			return ((logDensityPrefactor2) - (org.apache.commons.math3.util.FastMath.log(x))) + aux3;
		} 
		return ((logDensityPrefactor1) - y) + ((org.apache.commons.math3.util.FastMath.log(y)) * ((shape) - 1));
	}
