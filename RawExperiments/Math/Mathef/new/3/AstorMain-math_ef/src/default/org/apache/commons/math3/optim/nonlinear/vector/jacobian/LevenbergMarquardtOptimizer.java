	...
	protected org.apache.commons.math3.optim.PointVectorValuePair doOptimize() {
		...
		while (true) {
			...
			for (double ratio = 0 ; ratio < 1.0E-4 ; ) {
				...
				if ((((org.apache.commons.math3.util.FastMath.abs(actRed)) <= (org.apache.commons.math3.optim.nonlinear.vector.jacobian.LevenbergMarquardtOptimizer.TWO_EPS)) && (preRed <= (org.apache.commons.math3.optim.nonlinear.vector.jacobian.LevenbergMarquardtOptimizer.TWO_EPS))) && (ratio <= 2.0)) {
				...
				} else if (delta <= ((org.apache.commons.math3.optim.nonlinear.vector.jacobian.LevenbergMarquardtOptimizer.TWO_EPS) * xNorm)) {
				...
				} else if (maxCosine <= (org.apache.commons.math3.optim.nonlinear.vector.jacobian.LevenbergMarquardtOptimizer.TWO_EPS)) {
