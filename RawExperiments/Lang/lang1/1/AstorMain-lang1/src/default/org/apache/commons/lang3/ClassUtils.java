...
public class ClassUtils {
	...
	static {
		for (final java.lang.Class<?> primitiveClass : org.apache.commons.lang3.ClassUtils.primitiveWrapperMap.keySet()) {
			final java.lang.Class<?> wrapperClass = org.apache.commons.lang3.ClassUtils.primitiveWrapperMap.get(primitiveClass);
	...
	private static void addAbbreviation(final java.lang.String primitive, final java.lang.String abbreviation) {
	...
	public static java.lang.Class<?> getClass(final java.lang.ClassLoader classLoader, final java.lang.String className, final boolean initialize) throws java.lang.ClassNotFoundException {
		try {
			...
			if (org.apache.commons.lang3.ClassUtils.abbreviationMap.containsKey(className)) {
				final java.lang.String clsName = "[" + (org.apache.commons.lang3.ClassUtils.abbreviationMap.get(className));
