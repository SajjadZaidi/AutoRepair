...
public class TestUtils {
	...
	private static final org.apache.commons.math3.stat.inference.KolmogorovSmirnovTest KS_TEST = new org.apache.commons.math3.stat.inference.KolmogorovSmirnovTest();
	...
	public static double kolmogorovSmirnovStatistic(org.apache.commons.math3.distribution.RealDistribution dist, double[] data) throws org.apache.commons.math3.exception.InsufficientDataException, org.apache.commons.math3.exception.NullArgumentException {
		return org.apache.commons.math3.stat.inference.TestUtils.KS_TEST.kolmogorovSmirnovStatistic(dist, data);
	}

	public static double kolmogorovSmirnovTest(org.apache.commons.math3.distribution.RealDistribution dist, double[] data) throws org.apache.commons.math3.exception.InsufficientDataException, org.apache.commons.math3.exception.NullArgumentException {
		return org.apache.commons.math3.stat.inference.TestUtils.KS_TEST.kolmogorovSmirnovTest(dist, data);
	}

	public static double kolmogorovSmirnovTest(org.apache.commons.math3.distribution.RealDistribution dist, double[] data, boolean strict) throws org.apache.commons.math3.exception.InsufficientDataException, org.apache.commons.math3.exception.NullArgumentException {
		return org.apache.commons.math3.stat.inference.TestUtils.KS_TEST.kolmogorovSmirnovTest(dist, data, strict);
	}

	public static boolean kolmogorovSmirnovTest(org.apache.commons.math3.distribution.RealDistribution dist, double[] data, double alpha) throws org.apache.commons.math3.exception.InsufficientDataException, org.apache.commons.math3.exception.NullArgumentException {
		return org.apache.commons.math3.stat.inference.TestUtils.KS_TEST.kolmogorovSmirnovTest(dist, data, alpha);
	}

	public static double kolmogorovSmirnovStatistic(double[] x, double[] y) throws org.apache.commons.math3.exception.InsufficientDataException, org.apache.commons.math3.exception.NullArgumentException {
		return org.apache.commons.math3.stat.inference.TestUtils.KS_TEST.kolmogorovSmirnovStatistic(x, y);
	}

	public static double kolmogorovSmirnovTest(double[] x, double[] y) throws org.apache.commons.math3.exception.InsufficientDataException, org.apache.commons.math3.exception.NullArgumentException {
		return org.apache.commons.math3.stat.inference.TestUtils.KS_TEST.kolmogorovSmirnovTest(x, y);
	}

	public static double kolmogorovSmirnovTest(double[] x, double[] y, boolean strict) throws org.apache.commons.math3.exception.InsufficientDataException, org.apache.commons.math3.exception.NullArgumentException {
		return org.apache.commons.math3.stat.inference.TestUtils.KS_TEST.kolmogorovSmirnovTest(x, y, strict);
	}

	public static double exactP(double d, int m, int n, boolean strict) {
		return org.apache.commons.math3.stat.inference.TestUtils.KS_TEST.exactP(d, n, m, strict);
	}

	public static double approximateP(double d, int n, int m) {
		return org.apache.commons.math3.stat.inference.TestUtils.KS_TEST.approximateP(d, n, m);
	}

	public static double monteCarloP(double d, int n, int m, boolean strict, int iterations) {
		return org.apache.commons.math3.stat.inference.TestUtils.KS_TEST.monteCarloP(d, n, m, strict, iterations);
	}
}
