...
public class FieldUtils {
	...
	public static java.lang.reflect.Field getField(final java.lang.Class<?> cls, final java.lang.String fieldName, final boolean forceAccess) {
		...
		for (final java.lang.Class<?> class1 : org.apache.commons.lang3.ClassUtils.getAllInterfaces(cls)) {
			try {
				final java.lang.reflect.Field test = ((java.lang.Class<?>)(class1)).getField(fieldName);
				if (match != null) {
	...
	public static java.util.List<java.lang.reflect.Field> getAllFieldsList(java.lang.Class<?> cls) {
		...
		java.util.List<java.lang.reflect.Field> allFields = new java.util.ArrayList<java.lang.reflect.Field>();
