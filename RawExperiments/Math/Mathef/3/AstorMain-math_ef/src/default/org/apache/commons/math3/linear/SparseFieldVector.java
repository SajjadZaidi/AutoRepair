...
public class SparseFieldVector<T extends org.apache.commons.math3.FieldElement<T>> implements java.io.Serializable , org.apache.commons.math3.linear.FieldVector<T> {
	...
	public SparseFieldVector(org.apache.commons.math3.Field<T> field ,T[] values) throws org.apache.commons.math3.exception.NullArgumentException {
		org.apache.commons.math3.util.MathUtils.checkNotNull(values);
		this.field = field;
	...
	public org.apache.commons.math3.linear.FieldVector<T> append(T d) throws org.apache.commons.math3.exception.NullArgumentException {
	...
	public void set(T value) {
		org.apache.commons.math3.util.MathUtils.checkNotNull(value);
		for (int i = 0 ; i < (virtualSize) ; i++) {
			setEntry(i, value);
		}
	}

	public void setEntry(int index, T value) throws org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.OutOfRangeException {
		org.apache.commons.math3.util.MathUtils.checkNotNull(value);
		checkIndex(index);
	...
	public T[] toArray() {
		T[] res = org.apache.commons.math3.util.MathArrays.buildArray(field, virtualSize);
		org.apache.commons.math3.util.OpenIntToFieldHashMap<T>.Iterator iter = entries.iterator();
		while (iter.hasNext()) {
			iter.advance();
