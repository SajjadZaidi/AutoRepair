...
public class SmoothingPolynomialBicubicSplineInterpolator extends org.apache.commons.math3.analysis.interpolation.BicubicSplineInterpolator {
	...
	public SmoothingPolynomialBicubicSplineInterpolator(int degree) throws org.apache.commons.math3.exception.NotPositiveException {
		this(degree, degree);
	}

	public SmoothingPolynomialBicubicSplineInterpolator(int xDegree ,int yDegree) throws org.apache.commons.math3.exception.NotPositiveException {
		if (xDegree < 0) {
	...
	@java.lang.Override
	public org.apache.commons.math3.analysis.interpolation.BicubicSplineInterpolatingFunction interpolate(final double[] xval, final double[] yval, final double[][] fval) throws org.apache.commons.math3.exception.DimensionMismatchException, org.apache.commons.math3.exception.NoDataException, org.apache.commons.math3.exception.NonMonotonicSequenceException, org.apache.commons.math3.exception.NullArgumentException {
