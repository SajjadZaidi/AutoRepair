...
public class Covariance {
	...
	public Covariance(double[][] data ,boolean biasCorrected) throws org.apache.commons.math3.exception.MathIllegalArgumentException , org.apache.commons.math3.exception.NotStrictlyPositiveException {
		this(new org.apache.commons.math3.linear.BlockRealMatrix(data), biasCorrected);
	}

	public Covariance(double[][] data) throws org.apache.commons.math3.exception.MathIllegalArgumentException , org.apache.commons.math3.exception.NotStrictlyPositiveException {
		this(data, true);
	}
	...
	protected org.apache.commons.math3.linear.RealMatrix computeCovarianceMatrix(double[][] data, boolean biasCorrected) throws org.apache.commons.math3.exception.MathIllegalArgumentException, org.apache.commons.math3.exception.NotStrictlyPositiveException {
		return computeCovarianceMatrix(new org.apache.commons.math3.linear.BlockRealMatrix(data), biasCorrected);
	}

	protected org.apache.commons.math3.linear.RealMatrix computeCovarianceMatrix(double[][] data) throws org.apache.commons.math3.exception.MathIllegalArgumentException, org.apache.commons.math3.exception.NotStrictlyPositiveException {
