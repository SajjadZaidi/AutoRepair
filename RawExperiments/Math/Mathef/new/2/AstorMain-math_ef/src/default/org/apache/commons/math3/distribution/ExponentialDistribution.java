...
public class ExponentialDistribution extends org.apache.commons.math3.distribution.AbstractRealDistribution {
	...
	static {
		...
		while (qi < 1) {
			qi += (org.apache.commons.math3.util.FastMath.pow(LN2, i)) / (org.apache.commons.math3.util.CombinatoricsUtils.factorial(i));
			ra.addElement(qi);
			++i;
		}
	...
	public ExponentialDistribution(org.apache.commons.math3.random.RandomGenerator rng ,double mean) throws org.apache.commons.math3.exception.NotStrictlyPositiveException {
		this(rng, mean, org.apache.commons.math3.distribution.ExponentialDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
	}
	...
	public ExponentialDistribution(org.apache.commons.math3.random.RandomGenerator rng ,double mean ,double inverseCumAccuracy) throws org.apache.commons.math3.exception.NotStrictlyPositiveException {
		...
		this.mean = mean;
		logMean = org.apache.commons.math3.util.FastMath.log(mean);
