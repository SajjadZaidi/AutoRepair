...
public abstract class BaseOptimizer<PAIR> {
	...
	protected BaseOptimizer(org.apache.commons.math3.optim.ConvergenceChecker<PAIR> checker) {
		this(checker, 0, java.lang.Integer.MAX_VALUE);
	}

	protected BaseOptimizer(org.apache.commons.math3.optim.ConvergenceChecker<PAIR> checker ,int maxEval ,int maxIter) {
		this.checker = checker;
		evaluations = new org.apache.commons.math3.util.Incrementor(maxEval , new org.apache.commons.math3.optim.BaseOptimizer.MaxEvalCallback());
		iterations = new org.apache.commons.math3.util.Incrementor(maxIter , new org.apache.commons.math3.optim.BaseOptimizer.MaxIterCallback());
	}
