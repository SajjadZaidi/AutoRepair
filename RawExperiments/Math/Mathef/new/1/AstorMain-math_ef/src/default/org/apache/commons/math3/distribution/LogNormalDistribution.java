...
public class LogNormalDistribution extends org.apache.commons.math3.distribution.AbstractRealDistribution {
	...
	public LogNormalDistribution(org.apache.commons.math3.random.RandomGenerator rng ,double scale ,double shape) throws org.apache.commons.math3.exception.NotStrictlyPositiveException {
		this(rng, scale, shape, org.apache.commons.math3.distribution.LogNormalDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
	}
	...
	public LogNormalDistribution(org.apache.commons.math3.random.RandomGenerator rng ,double scale ,double shape ,double inverseCumAccuracy) throws org.apache.commons.math3.exception.NotStrictlyPositiveException {
		...
		this.scale = scale;
		this.shape = shape;
		this.logShapePlusHalfLog2Pi = (org.apache.commons.math3.util.FastMath.log(shape)) + (0.5 * (org.apache.commons.math3.util.FastMath.log((2 * (org.apache.commons.math3.util.FastMath.PI)))));
	...
	public double getNumericalVariance() {
		...
		final double ss = s * s;
		return (org.apache.commons.math3.util.FastMath.expm1(ss)) * (org.apache.commons.math3.util.FastMath.exp(((2 * (scale)) + ss)));
	}
