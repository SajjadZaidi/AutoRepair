...
Data {
        ...
        void read(org.jsoup.parser.Tokeniser t, org.jsoup.parser.CharacterReader r) {
            java.lang.String value = r.consumeToAny(org.jsoup.parser.TokeniserState.attributeDoubleValueCharsSorted);
            if ((value.length()) > 0) {
        ...
        void read(org.jsoup.parser.Tokeniser t, org.jsoup.parser.CharacterReader r) {
            java.lang.String value = r.consumeToAny(org.jsoup.parser.TokeniserState.attributeSingleValueCharsSorted);
            if ((value.length()) > 0) {
                t.tagPending.appendAttributeValue(value);
            } else {
                t.tagPending.setEmptyAttributeValue();
        ...
        void read(org.jsoup.parser.Tokeniser t, org.jsoup.parser.CharacterReader r) {
            java.lang.String value = r.consumeToAnySorted(org.jsoup.parser.TokeniserState.attributeValueUnquoted);
            if ((value.length()) > 0) {
                t.tagPending.appendAttributeValue(value);
            } 
            char c = r.consume();
    ...
    private static final char[] attributeSingleValueCharsSorted = new char[]{ '\'' , '&' , org.jsoup.parser.TokeniserState.nullChar };
    private static final char[] attributeDoubleValueCharsSorted = new char[]{ '"' , '&' , org.jsoup.parser.TokeniserState.nullChar };
    ...
    static {
        java.util.Arrays.sort(org.jsoup.parser.TokeniserState.attributeSingleValueCharsSorted);
        java.util.Arrays.sort(org.jsoup.parser.TokeniserState.attributeDoubleValueCharsSorted);
        java.util.Arrays.sort(org.jsoup.parser.TokeniserState.attributeNameCharsSorted);
        java.util.Arrays.sort(org.jsoup.parser.TokeniserState.attributeValueUnquoted);
    }
    ...
    private static void readData(org.jsoup.parser.Tokeniser t, org.jsoup.parser.CharacterReader r, org.jsoup.parser.TokeniserState current, org.jsoup.parser.TokeniserState advance) {
        switch (r.current()) {
            case '<' :
    ...
    private static void readCharRef(org.jsoup.parser.Tokeniser t, org.jsoup.parser.TokeniserState advance) {
    ...
    private static void readEndTag(org.jsoup.parser.Tokeniser t, org.jsoup.parser.CharacterReader r, org.jsoup.parser.TokeniserState a, org.jsoup.parser.TokeniserState b) {
        if (r.matchesLetter()) {
            t.createTagPending(false);
            t.transition(a);
        } else {
