...
public class UnivariateSolverUtils {
	...
	public static double[] bracket(org.apache.commons.math3.analysis.UnivariateFunction function, double initial, double lowerBound, double upperBound) throws org.apache.commons.math3.exception.NoBracketingException, org.apache.commons.math3.exception.NotStrictlyPositiveException, org.apache.commons.math3.exception.NullArgumentException {
		return org.apache.commons.math3.analysis.solvers.UnivariateSolverUtils.bracket(function, initial, lowerBound, upperBound, 1.0, 1.0, java.lang.Integer.MAX_VALUE);
	}
	...
	public static double[] bracket(org.apache.commons.math3.analysis.UnivariateFunction function, double initial, double lowerBound, double upperBound, int maximumIterations) throws org.apache.commons.math3.exception.NoBracketingException, org.apache.commons.math3.exception.NotStrictlyPositiveException, org.apache.commons.math3.exception.NullArgumentException {
		return org.apache.commons.math3.analysis.solvers.UnivariateSolverUtils.bracket(function, initial, lowerBound, upperBound, 1.0, 1.0, maximumIterations);
	}

	public static double[] bracket(final org.apache.commons.math3.analysis.UnivariateFunction function, final double initial, final double lowerBound, final double upperBound, final double q, final double r, final int maximumIterations) throws org.apache.commons.math3.exception.NoBracketingException {
		if (function == null) {
			throw new org.apache.commons.math3.exception.NullArgumentException(org.apache.commons.math3.exception.util.LocalizedFormats.FUNCTION);
		} 
		if (q <= 0) {
			throw new org.apache.commons.math3.exception.NotStrictlyPositiveException(q);
		} 
		...
		for (int numIterations = 0 ; (numIterations < maximumIterations) && ((a > lowerBound) || (b > upperBound)) ; ++numIterations) {
			...
			delta = (r * delta) + q;
			a = org.apache.commons.math3.util.FastMath.max((initial - delta), lowerBound);
			b = org.apache.commons.math3.util.FastMath.min((initial + delta), upperBound);
			fa = function.value(a);
			fb = function.value(b);
			if (numIterations == 0) {
				if ((fa * fb) <= 0) {
		...
		throw new org.apache.commons.math3.exception.NoBracketingException(a , b , fa , fb);
	}
