...
public class QRDecomposition {
	...
	protected void decompose(double[][] matrix) {
		for (int minor = 0 ; minor < (org.apache.commons.math3.util.FastMath.min(qrt.length, qrt[0].length)) ; minor++) {
	...
	private static class Solver implements org.apache.commons.math3.linear.DecompositionSolver {
		...
		public org.apache.commons.math3.linear.RealMatrix getInverse() {
			return solve(org.apache.commons.math3.linear.MatrixUtils.createRealIdentityMatrix(qrt[0].length));
		}
	}
}
