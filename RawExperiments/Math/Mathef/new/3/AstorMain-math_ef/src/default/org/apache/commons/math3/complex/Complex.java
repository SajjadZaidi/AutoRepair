	...
	public boolean equals(java.lang.Object other) {
		...
		if (other instanceof org.apache.commons.math3.complex.Complex) {
			...
			if (c.isNaN) {
				...
				return (org.apache.commons.math3.util.MathUtils.equals(real, c.real)) && (org.apache.commons.math3.util.MathUtils.equals(imaginary, c.imaginary));
			}
		} 
		return false;
	}

	public static boolean equals(org.apache.commons.math3.complex.Complex x, org.apache.commons.math3.complex.Complex y, int maxUlps) {
		return (org.apache.commons.math3.util.Precision.equals(x.real, y.real, maxUlps)) && (org.apache.commons.math3.util.Precision.equals(x.imaginary, y.imaginary, maxUlps));
	}

	public static boolean equals(org.apache.commons.math3.complex.Complex x, org.apache.commons.math3.complex.Complex y) {
		return org.apache.commons.math3.complex.Complex.equals(x, y, 1);
	}

	public static boolean equals(org.apache.commons.math3.complex.Complex x, org.apache.commons.math3.complex.Complex y, double eps) {
		return (org.apache.commons.math3.util.Precision.equals(x.real, y.real, eps)) && (org.apache.commons.math3.util.Precision.equals(x.imaginary, y.imaginary, eps));
	}

	public static boolean equalsWithRelativeTolerance(org.apache.commons.math3.complex.Complex x, org.apache.commons.math3.complex.Complex y, double eps) {
		return (org.apache.commons.math3.util.Precision.equalsWithRelativeTolerance(x.real, y.real, eps)) && (org.apache.commons.math3.util.Precision.equalsWithRelativeTolerance(x.imaginary, y.imaginary, eps));
	}
