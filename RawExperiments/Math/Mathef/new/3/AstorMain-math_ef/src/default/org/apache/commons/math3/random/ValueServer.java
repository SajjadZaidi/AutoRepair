...
public class ValueServer {
	...
	public ValueServer() {
		randomData = new org.apache.commons.math3.random.RandomDataGenerator();
	}
	...
	public ValueServer(org.apache.commons.math3.random.RandomGenerator generator) {
		this.randomData = new org.apache.commons.math3.random.RandomDataGenerator(generator);
	}
	...
	public void computeDistribution(int binCount) throws java.io.IOException, org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.exception.ZeroException {
		empiricalDistribution = new org.apache.commons.math3.random.EmpiricalDistribution(binCount , randomData.getRandomGenerator());
