...
public class EmpiricalDistribution extends org.apache.commons.math3.distribution.AbstractRealDistribution {
	...
	protected org.apache.commons.math3.distribution.RealDistribution getKernel(org.apache.commons.math3.stat.descriptive.SummaryStatistics bStats) {
		if ((bStats.getN()) == 1) {
			return new org.apache.commons.math3.distribution.ConstantRealDistribution(bStats.getMean());
		} else {
			return new org.apache.commons.math3.distribution.NormalDistribution(randomData.getRandomGenerator() , bStats.getMean() , bStats.getStandardDeviation() , org.apache.commons.math3.distribution.NormalDistribution.DEFAULT_INVERSE_ABSOLUTE_ACCURACY);
		}
	}
}
