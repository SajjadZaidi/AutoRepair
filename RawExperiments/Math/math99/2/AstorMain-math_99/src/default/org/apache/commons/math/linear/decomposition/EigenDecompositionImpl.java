...
public class EigenDecompositionImpl implements org.apache.commons.math.linear.decomposition.EigenDecomposition {
	...
	private static class Solver implements org.apache.commons.math.linear.decomposition.DecompositionSolver {
		...
		public org.apache.commons.math.linear.RealVector solve(final org.apache.commons.math.linear.RealVector b) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException {
			...
			final int m = realEigenvalues.length;
			if ((b.getDimension()) != m) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("vector length mismatch: got {0} but expected {1}", new java.lang.Object[]{ b.getDimension() , m });
			} 
			final double[] bp = new double[m];
			for (int i = 0 ; i < m ; ++i) {
				final org.apache.commons.math.linear.RealVectorImpl v = eigenvectors[i];
	...
	private int goodStep(final int start, final int end) {
		...
		for (boolean deflating = true ; deflating ; ) {
			...
			if ((start == (deflatedEnd - 1)) || ((start != (deflatedEnd - 2)) && (((work[(k - 5)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * ((sigma) + (work[(k - 3)])))) || ((work[((k - (2 * (pingPong))) - 4)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * (work[(k - 7)])))))) {
				...
				deflatedEnd -= 1;
			} else if (((start == (deflatedEnd - 2)) || ((work[(k - 9)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * (sigma)))) || ((work[((k - (2 * (pingPong))) - 8)]) <= ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE_2) * (work[(k - 11)])))) {
		...
		if (((dMin) < 0) || (((org.apache.commons.math.util.MathUtils.SAFE_MIN) * (qMax)) < (java.lang.Math.min(work[(l - 1)], java.lang.Math.min(work[(l - 9)], ((dMin2) + (work[(l - (2 * (pingPong)))]))))))) {
			...
			for (boolean loop = true ; loop ; ) {
				...
				if (((dMin) >= 0) && ((dMin1) > 0)) {
					updateSigma(tau);
					return deflatedEnd;
				} else if (((((dMin) < 0.0) && ((dMin1) > 0.0)) && ((work[(((4 * deflatedEnd) - 5) - (pingPong))]) < ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE) * ((sigma) + (dN1))))) && ((java.lang.Math.abs(dN)) < ((org.apache.commons.math.linear.decomposition.EigenDecompositionImpl.TOLERANCE) * (sigma)))) {
