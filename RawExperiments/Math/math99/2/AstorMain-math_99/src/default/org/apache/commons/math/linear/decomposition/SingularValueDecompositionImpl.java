	...
	private static class Solver implements org.apache.commons.math.linear.decomposition.DecompositionSolver {
		...
		public double[] solve(final double[] b) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException {
			if ((b.length) != (singularValues.length)) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("vector length mismatch: got {0} but expected {1}", new java.lang.Object[]{ b.length , singularValues.length });
			} 
		...
		public org.apache.commons.math.linear.RealVector solve(final org.apache.commons.math.linear.RealVector b) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException {
			if ((b.getDimension()) != (singularValues.length)) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("vector length mismatch: got {0} but expected {1}", new java.lang.Object[]{ b.getDimension() , singularValues.length });
			} 
		...
		public org.apache.commons.math.linear.RealMatrix solve(final org.apache.commons.math.linear.RealMatrix b) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException {
			if ((b.getRowDimension()) != (singularValues.length)) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("dimensions mismatch: got {0}x{1} but expected {2}x{3}", new java.lang.Object[]{ b.getRowDimension() , b.getColumnDimension() , singularValues.length , "n" });
			} 
