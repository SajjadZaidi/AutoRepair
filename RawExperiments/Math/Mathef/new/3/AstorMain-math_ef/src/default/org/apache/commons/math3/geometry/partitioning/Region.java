...
INSIDE, OUTSIDE, BOUNDARY;	}
	...
	boolean isFull(final org.apache.commons.math3.geometry.partitioning.BSPTree<S> node);

	boolean contains(final org.apache.commons.math3.geometry.partitioning.Region<S> region);

	org.apache.commons.math3.geometry.partitioning.Region.Location checkPoint(final org.apache.commons.math3.geometry.Point<S> point);

	org.apache.commons.math3.geometry.partitioning.BoundaryProjection<S> projectToBoundary(final org.apache.commons.math3.geometry.Point<S> point);
	...
	org.apache.commons.math3.geometry.Point<S> getBarycenter();
