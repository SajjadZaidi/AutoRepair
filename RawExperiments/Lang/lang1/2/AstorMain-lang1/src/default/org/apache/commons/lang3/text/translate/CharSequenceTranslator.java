...
public abstract class CharSequenceTranslator {
	...
	public final void translate(final java.lang.CharSequence input, final java.io.Writer out) throws java.io.IOException {
		...
		while (pos < len) {
			...
			if (consumed == 0) {
				final char[] c = java.lang.Character.toChars(java.lang.Character.codePointAt(input, pos));
				out.write(c);
				pos += c.length;
				continue;
			} 
			for (int pt = 0 ; pt < consumed ; pt++) {
				pos += java.lang.Character.charCount(java.lang.Character.codePointAt(input, pt));
			}
		}
	}
