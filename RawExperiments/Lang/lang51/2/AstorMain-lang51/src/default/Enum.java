...
public abstract class Enum implements java.io.Serializable , java.lang.Comparable {
	...
	private void init(java.lang.String name) {
		...
		synchronized(Enum.class) {
			...
			if (entry == null) {
				...
				java.util.Map myMap = new java.util.WeakHashMap(Enum.cEnumClasses);
		...
		entry.map.put(name, Enum.this);
		entry.list.add(Enum.this);
	}

	protected java.lang.Object readResolve() {
		Enum.Entry entry = ((Enum.Entry)(Enum.cEnumClasses.get(getEnumClass())));
		if (entry == null) {
			return null;
		} 
	...
	protected static Enum getEnum(java.lang.Class enumClass, java.lang.String name) {
		Enum.Entry entry = Enum.getEntry(enumClass);
		if (entry == null) {
			return null;
		} 
	...
	public final boolean equals(java.lang.Object other) {
		if (other == (Enum.this)) {
			...
			return false;
		} else if ((other.getClass()) == (Enum.this.getClass())) {
			return iName.equals(((Enum)(other)).iName);
		} else {
			if ((other.getClass().getName().equals(Enum.this.getClass().getName())) == false) {
				return false;
			} 
	...
	public int compareTo(java.lang.Object other) {
		...
		if ((other.getClass()) != (Enum.this.getClass())) {
			if (other.getClass().getName().equals(Enum.this.getClass().getName())) {
...
public abstract class Enum implements java.io.Serializable , java.lang.Comparable {
	...
	public final boolean equals(java.lang.Object other) {
		if (other == (org.apache.commons.lang.enum.Enum.this)) {
			...
			return false;
		} else if ((other.getClass()) == (org.apache.commons.lang.enum.Enum.this.getClass())) {
