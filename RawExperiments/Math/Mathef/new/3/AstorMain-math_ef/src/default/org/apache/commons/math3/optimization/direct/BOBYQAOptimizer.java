...
public class BOBYQAOptimizer extends org.apache.commons.math3.optimization.direct.BaseAbstractMultivariateSimpleBoundsOptimizer<org.apache.commons.math3.analysis.MultivariateFunction> implements org.apache.commons.math3.optimization.MultivariateOptimizer {
				...
				case 230 :
					{
						...
						if (ntrits == 0) {
							...
							for (int k = 0 ; k < npt ; k++) {
								...
								final double temp = org.apache.commons.math3.util.FastMath.max(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ONE, (d4 * d4));
								if ((temp * den) > scaden) {
									scaden = temp * den;
									knew = k;
									denom = den;
						...
						if (ntrits > 0) {
							...
							if (f < fopt) {
								...
								for (int k = 0 ; k < npt ; k++) {
									...
									final double temp = org.apache.commons.math3.util.FastMath.max(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ONE, (d3 * d3));
									if ((temp * den) > scaden) {
										scaden = temp * den;
										knew = k;
										denom = den;
						...
						if (ntrits > 0) {
							...
							for (int i = 0 ; i < n ; i++) {
								...
								if ((trustRegionCenterOffset.getEntry(i)) == (lowerDifference.getEntry(i))) {
									final double d1 = org.apache.commons.math3.util.FastMath.min(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO, gradientAtTrustRegionCenter.getEntry(i));
									gqsq += d1 * d1;
									final double d2 = org.apache.commons.math3.util.FastMath.min(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO, sum);
									gisq += d2 * d2;
								} else if ((trustRegionCenterOffset.getEntry(i)) == (upperDifference.getEntry(i))) {
									final double d1 = org.apache.commons.math3.util.FastMath.max(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO, gradientAtTrustRegionCenter.getEntry(i));
									gqsq += d1 * d1;
									final double d2 = org.apache.commons.math3.util.FastMath.max(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO, sum);
									gisq += d2 * d2;
								} else {
				...
				case 650 :
					{
						...
						if (knew >= 0) {
							...
							if (ntrits == (-1)) {
								delta = org.apache.commons.math3.util.FastMath.min(((org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ONE_OVER_TEN) * delta), ((org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.HALF) * dist));
								if (delta <= (rho * 1.5)) {
									delta = rho;
								} 
							} 
							ntrits = 0;
							final double d1 = org.apache.commons.math3.util.FastMath.min(((org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ONE_OVER_TEN) * dist), delta);
	...
	private double[] altmov(int knew, double adelt) {
		...
		for (int k = 0 ; k < npt ; k++) {
			...
			int ilbd = 0;
			int iubd = 0;
			final double sumin = org.apache.commons.math3.util.FastMath.min(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ONE, subd);
			for (int i = 0 ; i < n ; i++) {
				final double tmp = (interpolationPoints.getEntry(k, i)) - (trustRegionCenterOffset.getEntry(i));
				...
				} else if (tmp < (org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO)) {
			...
			if (k == knew) {
				...
				if ((subd > (org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.HALF)) && ((org.apache.commons.math3.util.FastMath.abs(vlag)) < (org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ONE_OVER_FOUR))) {
		...
		while (true) {
			...
			for (int i = 0 ; i < n ; i++) {
				...
				if (((org.apache.commons.math3.util.FastMath.min(((trustRegionCenterOffset.getEntry(i)) - (lowerDifference.getEntry(i))), glagValue)) > (org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO)) || ((org.apache.commons.math3.util.FastMath.max(((trustRegionCenterOffset.getEntry(i)) - (upperDifference.getEntry(i))), glagValue)) < (org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO))) {
			...
			if ((curv > (-gw)) && (curv < ((-gw) * ((org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ONE) + (org.apache.commons.math3.util.FastMath.sqrt(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.TWO)))))) {
		...
		do {
			...
			if (nfm <= (2 * n)) {
				if ((nfm >= 1) && (nfm <= n)) {
					...
					if ((lowerDifference.getEntry(nfxm)) == (org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO)) {
						stepb = org.apache.commons.math3.util.FastMath.min(((org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.TWO) * (initialTrustRegionRadius)), upperDifference.getEntry(nfxm));
					} 
					if ((upperDifference.getEntry(nfxm)) == (org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO)) {
						stepb = org.apache.commons.math3.util.FastMath.max(((-(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.TWO)) * (initialTrustRegionRadius)), lowerDifference.getEntry(nfxm));
					} 
			...
			if (numEval <= ((2 * n) + 1)) {
				if ((numEval >= 2) && (numEval <= (n + 1))) {
					...
					if (((stepa * stepb) < (org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO)) && (f < (fAtInterpolationPoints.getEntry((nfm - n))))) {
					...
					zMatrix.setEntry(0, nfxm, ((org.apache.commons.math3.util.FastMath.sqrt(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.TWO)) / (stepa * stepb)));
					zMatrix.setEntry(nfm, nfxm, ((org.apache.commons.math3.util.FastMath.sqrt(org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.HALF)) / rhosq));
	...
	private double[] trsbox(double delta, org.apache.commons.math3.linear.ArrayRealVector gnew, org.apache.commons.math3.linear.ArrayRealVector xbdi, org.apache.commons.math3.linear.ArrayRealVector s, org.apache.commons.math3.linear.ArrayRealVector hs, org.apache.commons.math3.linear.ArrayRealVector hred) {
		...
		for (int i = 0 ; i < n ; i++) {
			...
			} else if (((trustRegionCenterOffset.getEntry(i)) >= (upperDifference.getEntry(i))) && ((gradientAtTrustRegionCenter.getEntry(i)) <= (org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO))) {
				...
				case 50 :
					{
						...
						if (stplen > (org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO)) {
							...
							sdec = org.apache.commons.math3.util.FastMath.max(d1, org.apache.commons.math3.optimization.direct.BOBYQAOptimizer.ZERO);
							qred += sdec;
						} 
						if (iact >= 0) {
							++nact;
