...
public class PoissonDistribution extends org.apache.commons.math3.distribution.AbstractIntegerDistribution {
	...
	public double logProbability(int x) {
		...
		if ((x < 0) || (x == (java.lang.Integer.MAX_VALUE))) {
			...
			ret = (((-(org.apache.commons.math3.distribution.SaddlePointExpansion.getStirlingError(x))) - (org.apache.commons.math3.distribution.SaddlePointExpansion.getDeviancePart(x, mean))) - (0.5 * (org.apache.commons.math3.util.FastMath.log(org.apache.commons.math3.util.MathUtils.TWO_PI)))) - (0.5 * (org.apache.commons.math3.util.FastMath.log(x)));
		}
		return ret;
	}
	...
	private long nextPoisson(double meanPoisson) {
		...
		if (meanPoisson < pivot) {
			...
			final double logLambdaFactorial = org.apache.commons.math3.util.CombinatoricsUtils.factorialLog(((int)(lambda)));
			...
			for ( ;  ; ) {
				...
				if (v < (((y * logLambda) - (org.apache.commons.math3.util.CombinatoricsUtils.factorialLog(((int)(y + lambda))))) + logLambdaFactorial)) {
					y = lambda + y;
					break;
				} 
			}
