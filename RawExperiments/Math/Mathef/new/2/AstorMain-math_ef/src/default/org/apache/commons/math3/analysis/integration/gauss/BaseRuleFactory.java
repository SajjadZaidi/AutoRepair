...
public abstract class BaseRuleFactory<T extends java.lang.Number> {
	...
	public org.apache.commons.math3.util.Pair<double[], double[]> getRule(int numberOfPoints) throws org.apache.commons.math3.exception.DimensionMismatchException, org.apache.commons.math3.exception.NotStrictlyPositiveException {
		if (numberOfPoints <= 0) {
	...
	protected synchronized org.apache.commons.math3.util.Pair<T[], T[]> getRuleInternal(int numberOfPoints) throws org.apache.commons.math3.exception.DimensionMismatchException {
	...
	protected void addRule(org.apache.commons.math3.util.Pair<T[], T[]> rule) throws org.apache.commons.math3.exception.DimensionMismatchException {
	...
	protected abstract org.apache.commons.math3.util.Pair<T[], T[]> computeRule(int numberOfPoints) throws org.apache.commons.math3.exception.DimensionMismatchException;
