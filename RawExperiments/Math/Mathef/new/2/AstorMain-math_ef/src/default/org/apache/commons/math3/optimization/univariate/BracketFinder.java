...
public class BracketFinder {
	...
	public void search(org.apache.commons.math3.analysis.UnivariateFunction func, org.apache.commons.math3.optimization.GoalType goal, double xA, double xB) {
		...
		while (isMinim ? fC < fB : fC > fB) {
			...
			double denom = (org.apache.commons.math3.util.FastMath.abs(val)) < (org.apache.commons.math3.optimization.univariate.BracketFinder.EPS_MIN) ? 2 * (org.apache.commons.math3.optimization.univariate.BracketFinder.EPS_MIN) : 2 * val;
