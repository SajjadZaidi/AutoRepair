...
public class EigenDecompositionImpl implements org.apache.commons.math.linear.EigenDecomposition {
	...
	private void process3RowsBlock(final int index) throws org.apache.commons.math.linear.InvalidMatrixException {
		...
		if (delta > 0) {
			...
			z0 = (alpha * (java.lang.Math.cos((theta / 3)))) - beta;
			z1 = (alpha * (java.lang.Math.cos(((theta + (2 * (java.lang.Math.PI))) / 3)))) - beta;
			z2 = (alpha * (java.lang.Math.cos(((theta + (4 * (java.lang.Math.PI))) / 3)))) - beta;
		} else {
			final double cbrtR = java.lang.Math.cbrt(r);
			z0 = (2 * cbrtR) - beta;
			z1 = (-cbrtR) - beta;
			z2 = z1;
		}
