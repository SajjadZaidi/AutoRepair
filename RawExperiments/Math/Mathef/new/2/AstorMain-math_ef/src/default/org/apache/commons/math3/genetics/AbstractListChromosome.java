...
public abstract class AbstractListChromosome<T> extends org.apache.commons.math3.genetics.Chromosome {
	...
	public AbstractListChromosome(final java.util.List<T> representation ,final boolean copyList) {
		checkValidity(representation);
		this.representation = java.util.Collections.unmodifiableList((copyList ? new java.util.ArrayList<T>(representation) : representation));
	}
