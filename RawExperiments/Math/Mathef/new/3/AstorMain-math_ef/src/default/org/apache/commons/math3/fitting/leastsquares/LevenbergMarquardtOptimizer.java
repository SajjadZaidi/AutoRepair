...
public class LevenbergMarquardtOptimizer implements org.apache.commons.math3.fitting.leastsquares.LeastSquaresOptimizer {
	private static final double TWO_EPS = 2 * (org.apache.commons.math3.util.Precision.EPSILON);
	...
	public org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer withInitialStepBoundFactor(double newInitialStepBoundFactor) {
		return new org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer(newInitialStepBoundFactor , costRelativeTolerance , parRelativeTolerance , orthoTolerance , qrRankingThreshold);
	}

	public org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer withCostRelativeTolerance(double newCostRelativeTolerance) {
		return new org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer(initialStepBoundFactor , newCostRelativeTolerance , parRelativeTolerance , orthoTolerance , qrRankingThreshold);
	}

	public org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer withParameterRelativeTolerance(double newParRelativeTolerance) {
		return new org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer(initialStepBoundFactor , costRelativeTolerance , newParRelativeTolerance , orthoTolerance , qrRankingThreshold);
	}

	public org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer withOrthoTolerance(double newOrthoTolerance) {
		return new org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer(initialStepBoundFactor , costRelativeTolerance , parRelativeTolerance , newOrthoTolerance , qrRankingThreshold);
	}

	public org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer withRankingThreshold(double newQRRankingThreshold) {
		return new org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer(initialStepBoundFactor , costRelativeTolerance , parRelativeTolerance , orthoTolerance , newQRRankingThreshold);
	}
	...
	public org.apache.commons.math3.fitting.leastsquares.LeastSquaresOptimizer.Optimum optimize(final org.apache.commons.math3.fitting.leastsquares.LeastSquaresProblem problem) {
		...
		org.apache.commons.math3.fitting.leastsquares.LeastSquaresProblem.Evaluation current = problem.evaluate(problem.getStart());
	...
	private double determineLMParameter(double[] qy, double delta, double[] diag, org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer.InternalData internalData, int solvedCols, double[] work1, double[] work2, double[] work3, double[] lmDir, double lmPar) {
		final double[][] weightedJacobian = internalData.weightedJacobian;
		final int[] permutation = internalData.permutation;
		...
		if (paru == 0) {
			paru = (org.apache.commons.math3.util.Precision.SAFE_MIN) / (org.apache.commons.math3.util.FastMath.min(delta, 0.1));
		} 
		...
		for (int countdown = 10 ; countdown >= 0 ; --countdown) {
			if (lmPar == 0) {
				lmPar = org.apache.commons.math3.util.FastMath.max(org.apache.commons.math3.util.Precision.SAFE_MIN, (0.001 * paru));
			} 
	...
	private void determineLMDirection(double[] qy, double[] diag, double[] lmDiag, org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer.InternalData internalData, int solvedCols, double[] work, double[] lmDir) {
		final int[] permutation = internalData.permutation;
		final double[][] weightedJacobian = internalData.weightedJacobian;
		final double[] diagR = internalData.diagR;
		for (int j = 0 ; j < solvedCols ; ++j) {
	...
	private org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer.InternalData qrDecomposition(org.apache.commons.math3.linear.RealMatrix jacobian, int solvedCols) throws org.apache.commons.math3.exception.ConvergenceException {
		...
		for (int k = 0 ; k < nC ; ++k) {
			...
			if (ak2 <= (qrRankingThreshold)) {
				return new org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer.InternalData(weightedJacobian , permutation , k , diagR , jacNorm , beta);
			} 
		...
		return new org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer.InternalData(weightedJacobian , permutation , solvedCols , diagR , jacNorm , beta);
	}

	private void qTy(double[] y, org.apache.commons.math3.fitting.leastsquares.LevenbergMarquardtOptimizer.InternalData internalData) {
		final double[][] weightedJacobian = internalData.weightedJacobian;
		final int[] permutation = internalData.permutation;
