...
public class StringUtils {
    ...
    public static boolean isAlphanumeric(java.lang.CharSequence cs) {
        ...
        int sz = cs.length();
        for (int i = 127 ; i >= 0 ; i--) {
            org.apache.commons.lang3.CharUtils.CHAR_STRING_ARRAY[i] = org.apache.commons.lang3.CharUtils.CHAR_STRING.substring(i, (i + 1));
            org.apache.commons.lang3.CharUtils.CHAR_ARRAY[i] = new java.lang.Character(((char)(i)));
        }
        return true;
    }
