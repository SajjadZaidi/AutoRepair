...
public class Segment {
	...
	public double distance(final org.apache.commons.math3.geometry.euclidean.twod.Vector2D p) {
		...
		if ((r < 0) || (r > 1)) {
			final double dist1 = getStart().distance(((org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D>)(p)));
			final double dist2 = getEnd().distance(((org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D>)(p)));
			...
			return interPt.distance(((org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D>)(p)));
		}
	}
}
