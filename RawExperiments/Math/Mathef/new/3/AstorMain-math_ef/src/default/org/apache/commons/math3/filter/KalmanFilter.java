...
public class KalmanFilter {
	...
	public KalmanFilter(final org.apache.commons.math3.filter.ProcessModel process ,final org.apache.commons.math3.filter.MeasurementModel measurement) throws org.apache.commons.math3.exception.DimensionMismatchException , org.apache.commons.math3.exception.NullArgumentException , org.apache.commons.math3.linear.MatrixDimensionMismatchException , org.apache.commons.math3.linear.NonSquareMatrixException {
		...
		if (((((controlMatrix) != null) && ((controlMatrix.getRowDimension()) > 0)) && ((controlMatrix.getColumnDimension()) > 0)) && ((controlMatrix.getRowDimension()) != (transitionMatrix.getRowDimension()))) {
			throw new org.apache.commons.math3.linear.MatrixDimensionMismatchException(controlMatrix.getRowDimension() , controlMatrix.getColumnDimension() , transitionMatrix.getRowDimension() , controlMatrix.getColumnDimension());
		} 
		...
		if ((measNoise.getRowDimension()) != (measurementMatrix.getRowDimension())) {
			throw new org.apache.commons.math3.linear.MatrixDimensionMismatchException(measNoise.getRowDimension() , measNoise.getColumnDimension() , measurementMatrix.getRowDimension() , measNoise.getColumnDimension());
		} 
	}
	...
	public void predict(final double[] u) throws org.apache.commons.math3.exception.DimensionMismatchException {
		predict(new org.apache.commons.math3.linear.ArrayRealVector(u , false));
	}
	...
	public void correct(final double[] z) throws org.apache.commons.math3.exception.DimensionMismatchException, org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.linear.SingularMatrixException {
		correct(new org.apache.commons.math3.linear.ArrayRealVector(z , false));
	}
	...
	public void correct(final org.apache.commons.math3.linear.RealVector z) throws org.apache.commons.math3.exception.DimensionMismatchException, org.apache.commons.math3.exception.NullArgumentException, org.apache.commons.math3.linear.SingularMatrixException {
		...
		org.apache.commons.math3.linear.RealMatrix kalmanGain = new org.apache.commons.math3.linear.CholeskyDecomposition(s).getSolver().solve(measurementMatrix.multiply(errorCovariance.transpose())).transpose();
