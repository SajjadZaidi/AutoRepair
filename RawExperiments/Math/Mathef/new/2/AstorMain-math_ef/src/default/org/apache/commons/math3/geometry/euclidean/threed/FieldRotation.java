...
public class FieldRotation<T extends org.apache.commons.math3.RealFieldElement<T>> implements java.io.Serializable {
	...
	public FieldRotation(final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> axis ,final T angle) throws org.apache.commons.math3.exception.MathIllegalArgumentException {
	...
	public FieldRotation(final T[][] m ,final double threshold) throws org.apache.commons.math3.geometry.euclidean.threed.NotARotationMatrixException {
	...
	public FieldRotation(org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> u1 ,org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> u2 ,org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 ,org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2) throws org.apache.commons.math3.exception.MathArithmeticException {
		final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> u3 = org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D.crossProduct(u1, u2).normalize();
		u2 = org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D.crossProduct(u3, u1).normalize();
		u1 = u1.normalize();
		final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v3 = org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D.crossProduct(v1, v2).normalize();
		v2 = org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D.crossProduct(v3, v1).normalize();
		v1 = v1.normalize();
		final T[][] array = org.apache.commons.math3.util.MathArrays.buildArray(u1.getX().getField(), 3, 3);
	...
	public FieldRotation(final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> u ,final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v) throws org.apache.commons.math3.exception.MathArithmeticException {
		...
		final T dot = org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D.dotProduct(u, v);
		if ((dot.getReal()) < ((2.0E-15 - 1.0) * (normProduct.getReal()))) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> w = u.orthogonal();
			...
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> q = org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D.crossProduct(v, u);
	...
	public FieldRotation(final org.apache.commons.math3.geometry.euclidean.threed.RotationOrder order ,final T alpha1 ,final T alpha2 ,final T alpha3) {
		final T one = alpha1.getField().getOne();
		final org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> r1 = new org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T>(new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(one , order.getA1()) , alpha1);
		final org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> r2 = new org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T>(new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(one , order.getA2()) , alpha2);
		final org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> r3 = new org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T>(new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(one , order.getA3()) , alpha3);
		final org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> composed = r1.applyTo(r2.applyTo(r3));
		q0 = composed.q0;
		q1 = composed.q1;
		q2 = composed.q2;
		q3 = composed.q3;
	...
	private T[] mat2quat(final T[][] ort) {
		final T[] quat = org.apache.commons.math3.util.MathArrays.buildArray(ort[0][0].getField(), 4);
	...
	public org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> revert() {
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T>(q0.negate() , q1 , q2 , q3 , false);
	}
	...
	public org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> getAxis() {
		...
		if ((squaredSine.getReal()) == 0) {
			final org.apache.commons.math3.Field<T> field = squaredSine.getField();
			return new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(field.getOne() , field.getZero() , field.getZero());
		} else if ((q0.getReal()) < 0) {
			T inverse = squaredSine.sqrt().reciprocal();
			return new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(q1.multiply(inverse) , q2.multiply(inverse) , q3.multiply(inverse));
		} 
	...
	public T[] getAngles(final org.apache.commons.math3.geometry.euclidean.threed.RotationOrder order) throws org.apache.commons.math3.geometry.euclidean.threed.CardanEulerSingularityException {
		if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.XYZ)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(0, 0, 1));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(1, 0, 0));
		...
		} else if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.XZY)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(0, 1, 0));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(1, 0, 0));
			if (((v2.getY().getReal()) < (-0.9999999999)) || ((v2.getY().getReal()) > 0.9999999999)) {
				throw new org.apache.commons.math3.geometry.euclidean.threed.CardanEulerSingularityException(true);
			} 
			return buildArray(v1.getZ().atan2(v1.getY()), v2.getY().asin().negate(), v2.getZ().atan2(v2.getX()));
		} else if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.YXZ)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(0, 0, 1));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(0, 1, 0));
			if (((v2.getZ().getReal()) < (-0.9999999999)) || ((v2.getZ().getReal()) > 0.9999999999)) {
				throw new org.apache.commons.math3.geometry.euclidean.threed.CardanEulerSingularityException(true);
			} 
			return buildArray(v1.getX().atan2(v1.getZ()), v2.getZ().asin().negate(), v2.getX().atan2(v2.getY()));
		} else if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.YZX)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(1, 0, 0));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(0, 1, 0));
			if (((v2.getX().getReal()) < (-0.9999999999)) || ((v2.getX().getReal()) > 0.9999999999)) {
				throw new org.apache.commons.math3.geometry.euclidean.threed.CardanEulerSingularityException(true);
			} 
			return buildArray(v1.getZ().negate().atan2(v1.getX()), v2.getX().asin(), v2.getZ().negate().atan2(v2.getY()));
		} else if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.ZXY)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(0, 1, 0));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(0, 0, 1));
			if (((v2.getY().getReal()) < (-0.9999999999)) || ((v2.getY().getReal()) > 0.9999999999)) {
				throw new org.apache.commons.math3.geometry.euclidean.threed.CardanEulerSingularityException(true);
			} 
			return buildArray(v1.getX().negate().atan2(v1.getY()), v2.getY().asin(), v2.getX().negate().atan2(v2.getZ()));
		} else if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.ZYX)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(1, 0, 0));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(0, 0, 1));
			if (((v2.getX().getReal()) < (-0.9999999999)) || ((v2.getX().getReal()) > 0.9999999999)) {
				throw new org.apache.commons.math3.geometry.euclidean.threed.CardanEulerSingularityException(true);
		...
		} else if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.XYX)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(1, 0, 0));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(1, 0, 0));
			if (((v2.getX().getReal()) < (-0.9999999999)) || ((v2.getX().getReal()) > 0.9999999999)) {
		...
		} else if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.XZX)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(1, 0, 0));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(1, 0, 0));
			if (((v2.getX().getReal()) < (-0.9999999999)) || ((v2.getX().getReal()) > 0.9999999999)) {
				throw new org.apache.commons.math3.geometry.euclidean.threed.CardanEulerSingularityException(false);
		...
		} else if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.YXY)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(0, 1, 0));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(0, 1, 0));
			if (((v2.getY().getReal()) < (-0.9999999999)) || ((v2.getY().getReal()) > 0.9999999999)) {
				throw new org.apache.commons.math3.geometry.euclidean.threed.CardanEulerSingularityException(false);
		...
		} else if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.YZY)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(0, 1, 0));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(0, 1, 0));
			if (((v2.getY().getReal()) < (-0.9999999999)) || ((v2.getY().getReal()) > 0.9999999999)) {
				throw new org.apache.commons.math3.geometry.euclidean.threed.CardanEulerSingularityException(false);
		...
		} else if (order == (org.apache.commons.math3.geometry.euclidean.threed.RotationOrder.ZXZ)) {
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v1 = applyTo(vector(0, 0, 1));
			final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> v2 = applyInverseTo(vector(0, 0, 1));
			if (((v2.getZ().getReal()) < (-0.9999999999)) || ((v2.getZ().getReal()) > 0.9999999999)) {
				throw new org.apache.commons.math3.geometry.euclidean.threed.CardanEulerSingularityException(false);
	...
	private T[] buildArray(final T a0, final T a1, final T a2) {
		final T[] array = org.apache.commons.math3.util.MathArrays.buildArray(a0.getField(), 3);
		array[0] = a0;
		array[1] = a1;
		array[2] = a2;
		return array;
	...
	private org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> vector(final double x, final double y, final double z) {
		final T zero = q0.getField().getZero();
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(zero.add(x) , zero.add(y) , zero.add(z));
	}
	...
	public T[][] getMatrix() {
		...
		final T[][] m = org.apache.commons.math3.util.MathArrays.buildArray(q0.getField(), 3, 3);
	...
	public org.apache.commons.math3.geometry.euclidean.threed.Rotation toRotation() {
		return new org.apache.commons.math3.geometry.euclidean.threed.Rotation(q0.getReal() , q1.getReal() , q2.getReal() , q3.getReal() , false);
	}

	public org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> applyTo(final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> u) {
		final T x = u.getX();
		final T y = u.getY();
		final T z = u.getZ();
		final T s = q1.multiply(x).add(q2.multiply(y)).add(q3.multiply(z));
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(q0.multiply(x.multiply(q0).subtract(q2.multiply(z).subtract(q3.multiply(y)))).add(s.multiply(q1)).multiply(2).subtract(x) , q0.multiply(y.multiply(q0).subtract(q3.multiply(x).subtract(q1.multiply(z)))).add(s.multiply(q2)).multiply(2).subtract(y) , q0.multiply(z.multiply(q0).subtract(q1.multiply(y).subtract(q2.multiply(x)))).add(s.multiply(q3)).multiply(2).subtract(z));
	}

	public org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> applyTo(final org.apache.commons.math3.geometry.euclidean.threed.Vector3D u) {
		final double x = u.getX();
		final double y = u.getY();
		final double z = u.getZ();
		final T s = q1.multiply(x).add(q2.multiply(y)).add(q3.multiply(z));
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(q0.multiply(q0.multiply(x).subtract(q2.multiply(z).subtract(q3.multiply(y)))).add(s.multiply(q1)).multiply(2).subtract(x) , q0.multiply(q0.multiply(y).subtract(q3.multiply(x).subtract(q1.multiply(z)))).add(s.multiply(q2)).multiply(2).subtract(y) , q0.multiply(q0.multiply(z).subtract(q1.multiply(y).subtract(q2.multiply(x)))).add(s.multiply(q3)).multiply(2).subtract(z));
	}
	...
	public static <T extends org.apache.commons.math3.RealFieldElement<T>>org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> applyTo(final org.apache.commons.math3.geometry.euclidean.threed.Rotation r, final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> u) {
		final T x = u.getX();
		final T y = u.getY();
		final T z = u.getZ();
		final T s = x.multiply(r.getQ1()).add(y.multiply(r.getQ2())).add(z.multiply(r.getQ3()));
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(x.multiply(r.getQ0()).subtract(z.multiply(r.getQ2()).subtract(y.multiply(r.getQ3()))).multiply(r.getQ0()).add(s.multiply(r.getQ1())).multiply(2).subtract(x) , y.multiply(r.getQ0()).subtract(x.multiply(r.getQ3()).subtract(z.multiply(r.getQ1()))).multiply(r.getQ0()).add(s.multiply(r.getQ2())).multiply(2).subtract(y) , z.multiply(r.getQ0()).subtract(y.multiply(r.getQ1()).subtract(x.multiply(r.getQ2()))).multiply(r.getQ0()).add(s.multiply(r.getQ3())).multiply(2).subtract(z));
	}

	public org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> applyInverseTo(final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> u) {
		final T x = u.getX();
		final T y = u.getY();
		final T z = u.getZ();
		final T s = q1.multiply(x).add(q2.multiply(y)).add(q3.multiply(z));
		final T m0 = q0.negate();
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(m0.multiply(x.multiply(m0).subtract(q2.multiply(z).subtract(q3.multiply(y)))).add(s.multiply(q1)).multiply(2).subtract(x) , m0.multiply(y.multiply(m0).subtract(q3.multiply(x).subtract(q1.multiply(z)))).add(s.multiply(q2)).multiply(2).subtract(y) , m0.multiply(z.multiply(m0).subtract(q1.multiply(y).subtract(q2.multiply(x)))).add(s.multiply(q3)).multiply(2).subtract(z));
	}

	public org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> applyInverseTo(final org.apache.commons.math3.geometry.euclidean.threed.Vector3D u) {
		final double x = u.getX();
		final double y = u.getY();
		final double z = u.getZ();
		final T s = q1.multiply(x).add(q2.multiply(y)).add(q3.multiply(z));
		final T m0 = q0.negate();
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(m0.multiply(m0.multiply(x).subtract(q2.multiply(z).subtract(q3.multiply(y)))).add(s.multiply(q1)).multiply(2).subtract(x) , m0.multiply(m0.multiply(y).subtract(q3.multiply(x).subtract(q1.multiply(z)))).add(s.multiply(q2)).multiply(2).subtract(y) , m0.multiply(m0.multiply(z).subtract(q1.multiply(y).subtract(q2.multiply(x)))).add(s.multiply(q3)).multiply(2).subtract(z));
	}
	...
	public static <T extends org.apache.commons.math3.RealFieldElement<T>>org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> applyInverseTo(final org.apache.commons.math3.geometry.euclidean.threed.Rotation r, final org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T> u) {
		final T x = u.getX();
		final T y = u.getY();
		final T z = u.getZ();
		final T s = x.multiply(r.getQ1()).add(y.multiply(r.getQ2())).add(z.multiply(r.getQ3()));
		final double m0 = -(r.getQ0());
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldVector3D<T>(x.multiply(m0).subtract(z.multiply(r.getQ2()).subtract(y.multiply(r.getQ3()))).multiply(m0).add(s.multiply(r.getQ1())).multiply(2).subtract(x) , y.multiply(m0).subtract(x.multiply(r.getQ3()).subtract(z.multiply(r.getQ1()))).multiply(m0).add(s.multiply(r.getQ2())).multiply(2).subtract(y) , z.multiply(m0).subtract(y.multiply(r.getQ1()).subtract(x.multiply(r.getQ2()))).multiply(m0).add(s.multiply(r.getQ3())).multiply(2).subtract(z));
	}

	public org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> applyTo(final org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> r) {
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T>(r.q0.multiply(q0).subtract(r.q1.multiply(q1).add(r.q2.multiply(q2)).add(r.q3.multiply(q3))) , r.q1.multiply(q0).add(r.q0.multiply(q1)).add(r.q2.multiply(q3).subtract(r.q3.multiply(q2))) , r.q2.multiply(q0).add(r.q0.multiply(q2)).add(r.q3.multiply(q1).subtract(r.q1.multiply(q3))) , r.q3.multiply(q0).add(r.q0.multiply(q3)).add(r.q1.multiply(q2).subtract(r.q2.multiply(q1))) , false);
	}

	public org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> applyTo(final org.apache.commons.math3.geometry.euclidean.threed.Rotation r) {
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T>(q0.multiply(r.getQ0()).subtract(q1.multiply(r.getQ1()).add(q2.multiply(r.getQ2())).add(q3.multiply(r.getQ3()))) , q0.multiply(r.getQ1()).add(q1.multiply(r.getQ0())).add(q3.multiply(r.getQ2()).subtract(q2.multiply(r.getQ3()))) , q0.multiply(r.getQ2()).add(q2.multiply(r.getQ0())).add(q1.multiply(r.getQ3()).subtract(q3.multiply(r.getQ1()))) , q0.multiply(r.getQ3()).add(q3.multiply(r.getQ0())).add(q2.multiply(r.getQ1()).subtract(q1.multiply(r.getQ2()))) , false);
	}

	public static <T extends org.apache.commons.math3.RealFieldElement<T>>org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> applyTo(final org.apache.commons.math3.geometry.euclidean.threed.Rotation r1, final org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> rInner) {
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T>(rInner.q0.multiply(r1.getQ0()).subtract(rInner.q1.multiply(r1.getQ1()).add(rInner.q2.multiply(r1.getQ2())).add(rInner.q3.multiply(r1.getQ3()))) , rInner.q1.multiply(r1.getQ0()).add(rInner.q0.multiply(r1.getQ1())).add(rInner.q2.multiply(r1.getQ3()).subtract(rInner.q3.multiply(r1.getQ2()))) , rInner.q2.multiply(r1.getQ0()).add(rInner.q0.multiply(r1.getQ2())).add(rInner.q3.multiply(r1.getQ1()).subtract(rInner.q1.multiply(r1.getQ3()))) , rInner.q3.multiply(r1.getQ0()).add(rInner.q0.multiply(r1.getQ3())).add(rInner.q1.multiply(r1.getQ2()).subtract(rInner.q2.multiply(r1.getQ1()))) , false);
	}

	public org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> applyInverseTo(final org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> r) {
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T>(r.q0.multiply(q0).add(r.q1.multiply(q1).add(r.q2.multiply(q2)).add(r.q3.multiply(q3))).negate() , r.q0.multiply(q1).add(r.q2.multiply(q3).subtract(r.q3.multiply(q2))).subtract(r.q1.multiply(q0)) , r.q0.multiply(q2).add(r.q3.multiply(q1).subtract(r.q1.multiply(q3))).subtract(r.q2.multiply(q0)) , r.q0.multiply(q3).add(r.q1.multiply(q2).subtract(r.q2.multiply(q1))).subtract(r.q3.multiply(q0)) , false);
	}

	public org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> applyInverseTo(final org.apache.commons.math3.geometry.euclidean.threed.Rotation r) {
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T>(q0.multiply(r.getQ0()).add(q1.multiply(r.getQ1()).add(q2.multiply(r.getQ2())).add(q3.multiply(r.getQ3()))).negate() , q1.multiply(r.getQ0()).add(q3.multiply(r.getQ2()).subtract(q2.multiply(r.getQ3()))).subtract(q0.multiply(r.getQ1())) , q2.multiply(r.getQ0()).add(q1.multiply(r.getQ3()).subtract(q3.multiply(r.getQ1()))).subtract(q0.multiply(r.getQ2())) , q3.multiply(r.getQ0()).add(q2.multiply(r.getQ1()).subtract(q1.multiply(r.getQ2()))).subtract(q0.multiply(r.getQ3())) , false);
	}

	public static <T extends org.apache.commons.math3.RealFieldElement<T>>org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> applyInverseTo(final org.apache.commons.math3.geometry.euclidean.threed.Rotation rOuter, final org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> rInner) {
		return new org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T>(rInner.q0.multiply(rOuter.getQ0()).add(rInner.q1.multiply(rOuter.getQ1()).add(rInner.q2.multiply(rOuter.getQ2())).add(rInner.q3.multiply(rOuter.getQ3()))).negate() , rInner.q0.multiply(rOuter.getQ1()).add(rInner.q2.multiply(rOuter.getQ3()).subtract(rInner.q3.multiply(rOuter.getQ2()))).subtract(rInner.q1.multiply(rOuter.getQ0())) , rInner.q0.multiply(rOuter.getQ2()).add(rInner.q3.multiply(rOuter.getQ1()).subtract(rInner.q1.multiply(rOuter.getQ3()))).subtract(rInner.q2.multiply(rOuter.getQ0())) , rInner.q0.multiply(rOuter.getQ3()).add(rInner.q1.multiply(rOuter.getQ2()).subtract(rInner.q2.multiply(rOuter.getQ1()))).subtract(rInner.q3.multiply(rOuter.getQ0())) , false);
	}

	private T[][] orthogonalizeMatrix(final T[][] m, final double threshold) throws org.apache.commons.math3.geometry.euclidean.threed.NotARotationMatrixException {
		T x00 = m[0][0];
		T x01 = m[0][1];
		T x02 = m[0][2];
		T x10 = m[1][0];
		...
		double fn = 0;
		double fn1;
		final T[][] o = org.apache.commons.math3.util.MathArrays.buildArray(m[0][0].getField(), 3, 3);
		int i = 0;
		while ((++i) < 11) {
	...
	public static <T extends org.apache.commons.math3.RealFieldElement<T>>T distance(final org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> r1, final org.apache.commons.math3.geometry.euclidean.threed.FieldRotation<T> r2) {
