...
public class Covariance {
	...
	public double covariance(final double[] xArray, final double[] yArray, boolean biasCorrected) throws java.lang.IllegalArgumentException {
		...
		if ((length == (yArray.length)) && (length > 1)) {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(("Arrays must have the same length and both must have at " + "least two elements. xArray has size {0}, yArray has {1} elements"), new java.lang.Object[]{ xArray.length , yArray.length });
		}
