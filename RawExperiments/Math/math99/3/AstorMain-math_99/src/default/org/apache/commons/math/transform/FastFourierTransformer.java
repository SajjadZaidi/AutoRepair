...
public class FastFourierTransformer implements java.io.Serializable {
	...
	private static class RootsOfUnity implements java.io.Serializable {
		...
		public synchronized boolean isForward() throws java.lang.IllegalStateException {
			if ((omegaCount) == 0) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalStateException("roots of unity have not been computed yet", null);
			} 
			return isForward;
		}
		...
		public synchronized double getOmegaReal(int k) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException {
			...
			if ((k < 0) || (k >= (omegaCount))) {
				throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("out of range root of unity index {0} (must be in [{1};{2}])", new java.lang.Object[]{ k , 0 , (omegaCount) - 1 });
			} 
			return omegaReal[k];
		}
