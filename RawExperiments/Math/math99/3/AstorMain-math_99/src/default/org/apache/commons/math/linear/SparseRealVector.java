...
public class SparseRealVector implements org.apache.commons.math.linear.RealVector {
	...
	protected void checkVectorDimensions(int n) throws java.lang.IllegalArgumentException {
		if ((getDimension()) != n) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("vector length mismatch: got {0} but expected {1}", new java.lang.Object[]{ getDimension() , n });
		} 
	}
