...
public class StringUtils {
    ...
    public static java.lang.String stripAccents(java.lang.CharSequence input) {
        if (input == null) {
            return null;
        } 
        try {
            java.lang.String result = null;
            if (org.apache.commons.lang3.StringUtils.java6Available) {
                result = org.apache.commons.lang3.StringUtils.removeAccentsJava6(input);
            } else {
                if (org.apache.commons.lang3.StringUtils.sunAvailable) {
                    result = org.apache.commons.lang3.StringUtils.removeAccentsSUN(input);
                } else {
                    throw new java.lang.UnsupportedOperationException("The stripAccents(CharSequence) method requires at least Java 1.6 or a Sun JVM");
                }
            }
            return result;
        } catch (java.lang.IllegalArgumentException iae) {
            throw new java.lang.RuntimeException("IllegalArgumentException occurred" , iae);
        } catch (java.lang.IllegalAccessException iae) {
            throw new java.lang.RuntimeException("IllegalAccessException occurred" , iae);
        } catch (java.lang.reflect.InvocationTargetException ite) {
            throw new java.lang.RuntimeException("InvocationTargetException occurred" , ite);
        } catch (java.lang.SecurityException se) {
            throw new java.lang.RuntimeException("SecurityException occurred" , se);
        }
    }

    private static java.lang.String removeAccentsJava6(java.lang.CharSequence text) throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        if ((!(org.apache.commons.lang3.StringUtils.java6Available)) || ((org.apache.commons.lang3.StringUtils.java6NormalizerFormNFD) == null)) {
            throw new java.lang.IllegalStateException("java.text.Normalizer is not available");
        } 
        java.lang.String result;
        result = ((java.lang.String)(org.apache.commons.lang3.StringUtils.java6NormalizeMethod.invoke(null, new java.lang.Object[]{ text , org.apache.commons.lang3.StringUtils.java6NormalizerFormNFD })));
        result = org.apache.commons.lang3.StringUtils.java6Pattern.matcher(result).replaceAll("");
        return result;
    }

    private static java.lang.String removeAccentsSUN(java.lang.CharSequence text) throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        if (!(org.apache.commons.lang3.StringUtils.sunAvailable)) {
            throw new java.lang.IllegalStateException("sun.text.Normalizer is not available");
        } 
        java.lang.String result;
        result = ((java.lang.String)(org.apache.commons.lang3.StringUtils.sunDecomposeMethod.invoke(null, new java.lang.Object[]{ text , java.lang.Boolean.FALSE , java.lang.Integer.valueOf(0) })));
        result = org.apache.commons.lang3.StringUtils.sunPattern.matcher(result).replaceAll("");
        return result;
    }

    private static boolean sunAvailable = false;

    private static java.lang.reflect.Method sunDecomposeMethod = null;

    private static final java.util.regex.Pattern sunPattern = java.util.regex.Pattern.compile("\\p{InCombiningDiacriticalMarks}+");

    private static boolean java6Available = false;

    private static java.lang.reflect.Method java6NormalizeMethod = null;

    private static java.lang.Object java6NormalizerFormNFD = null;

    private static final java.util.regex.Pattern java6Pattern = org.apache.commons.lang3.StringUtils.sunPattern;

    static {
        try {
            java.lang.Class<?> normalizerFormClass = java.lang.Thread.currentThread().getContextClassLoader().loadClass("java.text.Normalizer$Form");
            java6NormalizerFormNFD = normalizerFormClass.getField("NFD").get(null);
            java.lang.Class<?> normalizerClass = java.lang.Thread.currentThread().getContextClassLoader().loadClass("java.text.Normalizer");
            java6NormalizeMethod = normalizerClass.getMethod("normalize", new java.lang.Class[]{ java.lang.CharSequence.class , normalizerFormClass });
            java6Available = true;
        ...
        try {
            java.lang.Class<?> normalizerClass = java.lang.Thread.currentThread().getContextClassLoader().loadClass("sun.text.Normalizer");
            sunDecomposeMethod = normalizerClass.getMethod("decompose", new java.lang.Class[]{ java.lang.String.class , java.lang.Boolean.TYPE , java.lang.Integer.TYPE });
            sunAvailable = true;
        } catch (java.lang.ClassNotFoundException e) {
            sunAvailable = false;
        } catch (java.lang.NoSuchMethodException e) {
    ...
    public static boolean isAlphanumeric(java.lang.CharSequence cs) {
        if (cs == null) {
            return false;
            super(((org.apache.commons.lang3.text.StrLookup<?>)(null)), org.apache.commons.lang3.text.StrSubstitutor.DEFAULT_PREFIX, org.apache.commons.lang3.text.StrSubstitutor.DEFAULT_SUFFIX, org.apache.commons.lang3.text.StrSubstitutor.DEFAULT_ESCAPE);
        } 
        int sz = cs.length();
        for (int i = 0 ; i < sz ; i++) {
