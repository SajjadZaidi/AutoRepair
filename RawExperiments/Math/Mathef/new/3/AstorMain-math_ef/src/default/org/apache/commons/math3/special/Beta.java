...
public class Beta {
	...
	public static double regularizedBeta(double x, final double a, final double b, double epsilon, int maxIterations) {
		double ret;
		if (((((((java.lang.Double.isNaN(x)) || (java.lang.Double.isNaN(a))) || (java.lang.Double.isNaN(b))) || (x < 0)) || (x > 1)) || (a <= 0)) || (b <= 0)) {
			ret = java.lang.Double.NaN;
		} else if ((x > ((a + 1) / ((2 + b) + a))) && ((1 - x) <= ((b + 1) / ((2 + b) + a)))) {
			ret = 1 - (org.apache.commons.math3.special.Beta.regularizedBeta((1 - x), b, a, epsilon, maxIterations));
		} else {
			...
			ret = ((org.apache.commons.math3.util.FastMath.exp(((((a * (org.apache.commons.math3.util.FastMath.log(x))) + (b * (org.apache.commons.math3.util.FastMath.log1p((-x))))) - (org.apache.commons.math3.util.FastMath.log(a))) - (org.apache.commons.math3.special.Beta.logBeta(a, b))))) * 1.0) / (fraction.evaluate(x, epsilon, maxIterations));
		}
		return ret;
	}
