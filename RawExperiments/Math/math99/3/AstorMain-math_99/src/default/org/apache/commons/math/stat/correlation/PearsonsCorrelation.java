...
public class PearsonsCorrelation {
	...
	public PearsonsCorrelation(org.apache.commons.math.stat.correlation.Covariance covariance) {
		...
		if (covarianceMatrix == null) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("Covariance matrix is null", null);
		} 
	...
	public double correlation(final double[] xArray, final double[] yArray) throws java.lang.IllegalArgumentException {
		...
		if (((xArray.length) == (yArray.length)) && ((xArray.length) > 1)) {
			...
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("Invalid array dimensions. xArray has size {0}; yArray has {1} elements", new java.lang.Object[]{ xArray.length , yArray.length });
		}
	}
	...
	private void checkSufficientData(final org.apache.commons.math.linear.RealMatrix matrix) {
		...
		if ((nRows < 2) || (nCols < 2)) {
			throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException("Insufficient data: only {0} rows and {1} columns.", new java.lang.Object[]{ nRows , nCols });
		} 
	}
}
