...
public class SubLine extends org.apache.commons.math3.geometry.partitioning.AbstractSubHyperplane<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D, org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> {
	...
	public SubLine(final org.apache.commons.math3.geometry.euclidean.twod.Vector2D start ,final org.apache.commons.math3.geometry.euclidean.twod.Vector2D end ,final double tolerance) {
		super(new org.apache.commons.math3.geometry.euclidean.twod.Line(start , end , tolerance), org.apache.commons.math3.geometry.euclidean.twod.SubLine.buildIntervalSet(start, end, tolerance));
	}
	...
	public SubLine(final org.apache.commons.math3.geometry.euclidean.twod.Vector2D start ,final org.apache.commons.math3.geometry.euclidean.twod.Vector2D end) {
		this(start, end, org.apache.commons.math3.geometry.euclidean.twod.SubLine.DEFAULT_TOLERANCE);
	}

	public SubLine(final org.apache.commons.math3.geometry.euclidean.twod.Segment segment) {
		super(segment.getLine(), org.apache.commons.math3.geometry.euclidean.twod.SubLine.buildIntervalSet(segment.getStart(), segment.getEnd(), segment.getLine().getTolerance()));
	}
	...
	public java.util.List<org.apache.commons.math3.geometry.euclidean.twod.Segment> getSegments() {
		...
		final java.util.List<org.apache.commons.math3.geometry.euclidean.twod.Segment> segments = new java.util.ArrayList<org.apache.commons.math3.geometry.euclidean.twod.Segment>(list.size());
		for (final org.apache.commons.math3.geometry.euclidean.oned.Interval interval : list) {
			final org.apache.commons.math3.geometry.euclidean.twod.Vector2D start = line.toSpace(((org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D>)(new org.apache.commons.math3.geometry.euclidean.oned.Vector1D(interval.getInf()))));
			final org.apache.commons.math3.geometry.euclidean.twod.Vector2D end = line.toSpace(((org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D>)(new org.apache.commons.math3.geometry.euclidean.oned.Vector1D(interval.getSup()))));
	...
	public org.apache.commons.math3.geometry.euclidean.twod.Vector2D intersection(final org.apache.commons.math3.geometry.euclidean.twod.SubLine subLine, final boolean includeEndPoints) {
		...
		org.apache.commons.math3.geometry.partitioning.Region.Location loc1 = getRemainingRegion().checkPoint(line1.toSubSpace(((org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D>)(v2D))));
		org.apache.commons.math3.geometry.partitioning.Region.Location loc2 = subLine.getRemainingRegion().checkPoint(line2.toSubSpace(((org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D>)(v2D))));
		if (includeEndPoints) {
	...
	private static org.apache.commons.math3.geometry.euclidean.oned.IntervalsSet buildIntervalSet(final org.apache.commons.math3.geometry.euclidean.twod.Vector2D start, final org.apache.commons.math3.geometry.euclidean.twod.Vector2D end, final double tolerance) {
		final org.apache.commons.math3.geometry.euclidean.twod.Line line = new org.apache.commons.math3.geometry.euclidean.twod.Line(start , end , tolerance);
	...
	public org.apache.commons.math3.geometry.partitioning.Side side(final org.apache.commons.math3.geometry.partitioning.Hyperplane<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> hyperplane) {
		...
		final org.apache.commons.math3.geometry.euclidean.oned.Vector1D x = thisLine.toSubSpace(((org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D>)(crossing)));
		return getRemainingRegion().side(new org.apache.commons.math3.geometry.euclidean.oned.OrientedPoint(x , direct , thisLine.getTolerance()));
	}
	...
	public org.apache.commons.math3.geometry.partitioning.SubHyperplane.SplitSubHyperplane<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> split(final org.apache.commons.math3.geometry.partitioning.Hyperplane<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> hyperplane) {
		...
		final boolean direct = (org.apache.commons.math3.util.FastMath.sin(((thisLine.getAngle()) - (otherLine.getAngle())))) < 0;
		final org.apache.commons.math3.geometry.euclidean.oned.Vector1D x = thisLine.toSubSpace(((org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D>)(crossing)));
		final org.apache.commons.math3.geometry.partitioning.SubHyperplane<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> subPlus = new org.apache.commons.math3.geometry.euclidean.oned.OrientedPoint(x , (!direct) , tolerance).wholeHyperplane();
		final org.apache.commons.math3.geometry.partitioning.SubHyperplane<org.apache.commons.math3.geometry.euclidean.oned.Euclidean1D> subMinus = new org.apache.commons.math3.geometry.euclidean.oned.OrientedPoint(x , direct , tolerance).wholeHyperplane();
