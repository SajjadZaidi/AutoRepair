...
public class Vector2D implements org.apache.commons.math3.geometry.Vector<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> {
	...
	public static double angle(org.apache.commons.math3.geometry.euclidean.twod.Vector2D v1, org.apache.commons.math3.geometry.euclidean.twod.Vector2D v2) throws org.apache.commons.math3.exception.MathArithmeticException {
		...
		if ((dot < (-threshold)) || (dot > threshold)) {
			final double n = org.apache.commons.math3.util.FastMath.abs(org.apache.commons.math3.util.MathArrays.linearCombination(v1.x, v2.y, (-(v1.y)), v2.x));
			if (dot >= 0) {
				return org.apache.commons.math3.util.FastMath.asin((n / normProduct));
			} 
			return (org.apache.commons.math3.util.FastMath.PI) - (org.apache.commons.math3.util.FastMath.asin((n / normProduct)));
		} 
	...
	public double distance(org.apache.commons.math3.geometry.Vector<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> p) {
		return distance(((org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D>)(p)));
	}

	public double distance(org.apache.commons.math3.geometry.Point<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> p) {
		org.apache.commons.math3.geometry.euclidean.twod.Vector2D p3 = ((org.apache.commons.math3.geometry.euclidean.twod.Vector2D)(p));
	...
	public double dotProduct(final org.apache.commons.math3.geometry.Vector<org.apache.commons.math3.geometry.euclidean.twod.Euclidean2D> v) {
		...
		return org.apache.commons.math3.util.MathArrays.linearCombination(x, v2.x, y, v2.y);
	}

	public double crossProduct(final org.apache.commons.math3.geometry.euclidean.twod.Vector2D p1, final org.apache.commons.math3.geometry.euclidean.twod.Vector2D p2) {
		final double x1 = (p2.getX()) - (p1.getX());
		final double y1 = (getY()) - (p1.getY());
		final double x2 = (getX()) - (p1.getX());
		final double y2 = (p2.getY()) - (p1.getY());
		return org.apache.commons.math3.util.MathArrays.linearCombination(x1, y1, (-x2), y2);
	}
