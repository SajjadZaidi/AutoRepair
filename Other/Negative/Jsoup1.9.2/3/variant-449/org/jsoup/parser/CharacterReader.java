...
final class CharacterReader {
    ...
    CharacterReader(java.lang.String input) {
        ...
        this.length = org.jsoup.parser.CharacterReader.this.input.length;
    }
    ...
    char current() {
        return (pos) >= (length) ? org.jsoup.parser.CharacterReader.EOF : input[pos];
    }

    char consume() {
        char val = (pos) >= (length) ? org.jsoup.parser.CharacterReader.EOF : input[pos];
        (pos)++;
        return val;
    }
    ...
    private java.lang.String cacheString(final int start, final int count) {
        ...
        if (count > (org.jsoup.parser.CharacterReader.maxCacheLen)) {
