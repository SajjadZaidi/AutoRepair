        ...
        while ((n < maxIterations) && (relativeError > epsilon)) {
            ...
            if ((java.lang.Double.isInfinite(p2)) || (java.lang.Double.isInfinite(q2))) {
                ...
                for (int i = 0 ; i < maxPower ; i++) {
                    ...
                    org.apache.commons.math.analysis.polynomials.PolynomialsUtils.CHEBYSHEV_COEFFICIENTS = new java.util.ArrayList<org.apache.commons.math.fraction.BigFraction>();
                    if (!infinite) {
                        break;
                    } 
                }
