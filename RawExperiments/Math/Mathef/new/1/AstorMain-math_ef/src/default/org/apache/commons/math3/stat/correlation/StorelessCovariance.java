...
public class StorelessCovariance extends org.apache.commons.math3.stat.correlation.Covariance {
	...
	public void append(org.apache.commons.math3.stat.correlation.StorelessCovariance sc) throws org.apache.commons.math3.exception.DimensionMismatchException {
		if ((sc.dimension) != (dimension)) {
			throw new org.apache.commons.math3.exception.DimensionMismatchException(sc.dimension , dimension);
		} 
		for (int i = 0 ; i < (dimension) ; i++) {
